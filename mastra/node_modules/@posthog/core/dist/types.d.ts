 ...
 */
export type PostHogFlagsStorageFormat = Pick<PostHogFeatureFlagDetails, 'flags'> & Partial<Pick<PostHogFlagsResponse, 'requestId' | 'evaluatedAt'>> & {
    errorsWhileComputingFlags?: boolean;
    quotaLimited?: string[];
...
export declare const FeatureFlagError: {
    ...
    readonly apiError: (status: number) => string;
};
export type FeatureFlagErrorType = (typeof FeatureFlagError)[Exclude<keyof typeof FeatureFlagError, 'apiError'>] | ReturnType<typeof FeatureFlagError.apiError> | string;
/**
...
export declare const knownUnsafeEditableEventProperty: readonly ["token"];
/**
