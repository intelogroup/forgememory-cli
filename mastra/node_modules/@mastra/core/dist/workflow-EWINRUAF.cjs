...
function buildBackgroundTaskWorkflow(manager) {
  const runAttemptStep = chunk6ZBUYPOD_cjs.createStep2({
    id: "run-attempt",
  ...
  const classifyOutcomeStep = chunk6ZBUYPOD_cjs.createStep2({
    id: "classify-outcome",
  ...
  const attemptBodyWorkflow = chunk6ZBUYPOD_cjs.createWorkflow2({
    id: `${chunkVRAH6SOV_cjs.BACKGROUND_TASK_WORKFLOW_ID}__attempt`,
    inputSchema: bodyIOSchema,
    outputSchema: bodyOutputSchema,
  ...
  return chunk6ZBUYPOD_cjs.createWorkflow2({
    id: chunkVRAH6SOV_cjs.BACKGROUND_TASK_WORKFLOW_ID,
    inputSchema,
    outputSchema: bodyOutputSchema,
...
Object.defineProperty(exports, "BACKGROUND_TASK_WORKFLOW_ID", {
  enumerable: true,
  get: function () { return chunkVRAH6SOV_cjs.BACKGROUND_TASK_WORKFLOW_ID; }
});
exports.buildBackgroundTaskWorkflow = buildBackgroundTaskWorkflow;
//# sourceMappingURL=workflow-EWINRUAF.cjs.map
//# sourceMappingURL=workflow-EWINRUAF.cjs.map