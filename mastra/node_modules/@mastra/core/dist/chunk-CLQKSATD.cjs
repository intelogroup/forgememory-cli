...
var WorkflowRunOutput = class {
  ...
  #streamError;
  #delayedPromises = {
    usage: new chunkUHTO5JDE_cjs.DelayedPromise(),
    result: new chunkUHTO5JDE_cjs.DelayedPromise()
  };
  /**
  ...
  switch (chunk.type) {
    ...
    case "file": {
      const filePart = mode === "generate" ? {
        type: "file",
        file: new chunk2TATDSHU_cjs.DefaultGeneratedFile({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      } : {
        type: "file",
        file: new chunk2TATDSHU_cjs.DefaultGeneratedFileWithType({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      };
...
//# sourceMappingURL=chunk-CLQKSATD.cjs.map
//# sourceMappingURL=chunk-CLQKSATD.cjs.map