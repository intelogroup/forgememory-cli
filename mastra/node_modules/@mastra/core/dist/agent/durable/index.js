import { CachingPubSub } from '../../chunk-IFTTFPB4.js';
import { SaveQueueManager, createStep, mergeProviderOptions, execute, createWorkflow, runScorer, Agent } from '../../chunk-5YZI33XV.js';
import { PUBSUB_SYMBOL } from '../../chunk-2QXNHEDL.js';
import { MastraModelOutput, isSupportedLanguageModel, ProcessorRunner, safeEnqueue, safeClose } from '../../chunk-X4ZG5TF4.js';
import { resolveModelConfig } from '../../chunk-EAE64RJ5.js';
import { EventEmitterPubSub } from '../../chunk-SFA7SIBL.js';
import { InMemoryServerCache } from '../../chunk-366PLPDH.js';
import { deepMerge } from '../../chunk-VA4S6KHU.js';
import { getNeedsApprovalFn } from '../../chunk-LCWNYZTU.js';
import { createObservabilityContext } from '../../chunk-IX6V357L.js';
import { getStepAvailableToolNames } from '../../chunk-DEQCJWZZ.js';
import { resolveBackgroundConfig, createBackgroundTask } from '../../chunk-EWCGKWQ6.js';
import { MessageList } from '../../chunk-RIEQKS4L.js';
import { RequestContext, MASTRA_VERSIONS_KEY, mergeVersionOverrides, MASTRA_THREAD_ID_KEY, MASTRA_RESOURCE_ID_KEY } from '../../chunk-RI37F2KY.js';
...
async function prepareForDurableExecution(options) {
  ...
  if (execOptions?.versions) {
    mergedVersions = mergeVersionOverrides(mergedVersions, execOptions.versions);
  }
  if (mergedVersions) {
  ...
  if (inputProcessors.length > 0) {
    try {
      ...
      const { ProcessorRunner: ProcessorRunner2 } = await import('../../runner-3R5W2ZLT.js');
...
var globalRunRegistry = new TTLCache({
  max: 1e3,
  ttl: 10 * 60 * 1e3,
  updateAgeOnGet: true,
  dispose: (entry) => {
...
var modelListEntrySchema = z.object({
  id: z.string(),
  config: z.object({
    provider: z.string(),
    modelId: z.string(),
...
var accumulatedUsageSchema = z.object({
  inputTokens: z.number(),
  outputTokens: z.number(),
  totalTokens: z.number()
});
var durableAgenticOutputSchema = z.object({
...
var baseDurableAgenticInputSchema = z.object({
  runId: z.string(),
  agentId: z.string(),
...
var baseIterationStateSchema = z.object({
...
var bgCheckInputSchema = z.any();
var bgCheckOutputSchema = z.any();
...
var durableLLMInputSchema = z.object({
  runId: z.string(),
  agentId: z.string(),
  agentName: z.string().optional(),
  messageListState: z.any(),
...
var durableLLMOutputSchema = z.object({
  messageListState: z.any(),
  text: z.string().optional(),
  toolCalls: z.array(
    z.object({
      ...
      for (let modelIndex = 0; modelIndex < modelList.length; modelIndex++) {
        ...
        for (let attempt = 0; attempt <= maxRetries; attempt++) {
          try {
            ...
            let currentProviderOptions = mergeProviderOptions(
...
var durableToolCallInputSchema = z.object({
  toolCallId: z.string(),
  toolName: z.string(),
  args: z.record(z.string(), z.any()),
  providerMetadata: z.record(z.string(), z.any()).optional(),
...
var durableLLMMappingInputSchema = z.object({
  llmOutput: z.any(),
...
var durableLLMMappingOutputSchema = z.object({
  messageListState: z.any(),
  messageId: z.string(),
  stepResult: z.any(),
  toolResults: z.array(z.any()),
    ...
    async (params) => {
      ...
      if (registryEntry?.outputProcessors?.length) {
        try {
          ...
          await runner.runOutputProcessors(outputMessageList, {}, requestContext ?? new RequestContext(), 0);
        } catch (error) {
