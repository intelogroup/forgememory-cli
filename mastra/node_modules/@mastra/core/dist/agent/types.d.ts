import type { GenerateTextOnStepFinishCallback } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
import type { CallSettings } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
import type { ProviderDefinedTool } from '../_types/@internal_external-types/dist/index.d.ts';
...
import type { AgentChannels } from '../channels/agent-channels.js';
...
import type { NotificationDeliveryPolicyConfig } from '../notifications/delivery-policy.js';
import type { NotificationDeliveryDecision, NotificationRecord, SendNotificationSignalInput } from '../notifications/types.js';
import type { Span, SpanType, TracingOptions, TracingPolicy, ObservabilityContext } from '../observability/index.js';
...
import type { SignalProvider } from '../signals/signal-provider.js';
import type { MastraModelOutput } from '../stream/base/output.js';
import type { AgentChunkType, MastraOnFinishCallbackArgs, ModelManagerModelConfig } from '../stream/types.js';
import type { ToolAction, ToolHooks, VercelTool, VercelToolV5 } from '../tools/index.js';
import type { ToolPayloadTransformPolicy } from '../tools/types.js';
...
import type { AgentSignalAttributes, CreatedAgentSignal } from './signals.js';
import type { SubAgent } from './subagent.js';
export type { MastraDBMessage, MastraMessageContentV2, MastraMessagePart, UIMessageWithMetadata, MessageList, } from './message-list/index.js';
export type { Message as AiMessageType } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
export type { NotificationDeliveryPolicyConfig, NotificationDeliveryPolicyDecider, NotificationDeliveryPolicyDecision, NotificationDeliveryPolicyInput, } from '../notifications/delivery-policy.js';
export type { NotificationDeliveryAction, NotificationDeliveryDecision, NotificationDeliveryThreadState, NotificationPriority, NotificationRecord, NotificationSignalAttributes, NotificationStatus, NotificationSummary, SendNotificationSignalInput, } from '../notifications/types.js';
export type { LLMStepResult } from '../stream/types.js';
export type { MastraBrowser } from '../browser/browser.js';
export type { ScreencastOptions, ScreencastStream } from '../browser/browser.js';
 ...
 */
export type ToolsInput = Record<string, ToolAction<any, any, any, any, any> | VercelTool | VercelToolV5 | ProviderDefinedTool>;
export type AgentInstructions = SystemMessage;
export type { AgentMessageInput, AgentSignalAttributes, AgentSignalInput as AgentSignal, AgentSignalType, AgentSignalDataPart, AgentStateSignalInput, AgentStateSignalMode, CreatedAgentSignal, } from './signals.js';
/**
 ...
 * @experimental Agent state signal APIs are experimental and may change in a future release.
 */
export type SendAgentStateSignalResult = (SendAgentSignalResult & {
    skipped?: false;
}) | {
    accepted: true;
    skipped: true;
 ...
 * @experimental Agent notification signal APIs are experimental and may change in a future release.
 */
export type SendAgentNotificationSignalOptions<OUTPUT = unknown> = Extract<SendAgentSignalOptions<OUTPUT>, {
    resourceId: string;
    threadId: string;
}>;
/**
...
export type AgentEditorConfig = false | {
...
interface AgentConfigBase<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, TRequestContext extends Record<string, any> | unknown = unknown> {
    /**
 ...
 */
type EditorOwnsInstructions<TEditor> = TEditor extends {
    instructions: true;
} ? true : false;
type EditorOwnsToolMembership<TEditor> = TEditor extends {
    tools: true;
} ? true : false;
/**
 ...
 */
type AgentEditableFieldConfig<TTools extends ToolsInput, TRequestContext extends Record<string, any> | unknown, TEditor extends AgentEditorConfig | undefined> = (EditorOwnsInstructions<TEditor> extends true ? {
    instructions?: never;
} : {
    instructions: DynamicArgument<AgentInstructions, TRequestContext>;
...
export type AgentExecuteOnFinishOptions = {
    runId: string;
    result: MastraOnFinishCallbackArgs & {
        object?: unknown;
    };
 ...
 */
export declare function isDurableAgentLike(obj: any): obj is DurableAgentLike;
