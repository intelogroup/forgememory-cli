import type { UIMessage } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
...
import type { CoreTool, ToolHooks } from '../tools/types.js';
...
export declare class Agent<TAgentId extends string = string, TTools extends ToolsInput = ToolsInput, TOutput = undefined, TRequestContext extends Record<string, any> | unknown = unknown, TEditor extends AgentEditorConfig | undefined = AgentEditorConfig | undefined> extends MastraBase implements SubAgent<TAgentId, TRequestContext> {
    ...
    getMastraInstance(): Mastra<Record<string, Agent<any, ToolsInput, undefined, unknown, AgentEditorConfig | undefined>>, Record<string, AnyWorkflow>, Record<string, import("../vector").MastraVector<any>>, Record<string, import("../tts").MastraTTS>, import("../_types/@internal_core/dist/logger/index.d.ts").IMastraLogger, Record<string, import("../mcp").MCPServerBase<any>>, Record<string, MastraScorer<any, any, any, any>>, Record<string, import("../tools").ToolAction<any, any, any, any, any, any, unknown>>, Record<string, Processor<any, unknown>>, Record<string, MastraMemory>, Record<string, import("../channels").ChannelProvider>> | undefined;
     ...
     */
    setObjective(objective: string, options: {
        threadId: string;
        resourceId?: string;
        judgeModelId?: string;
        maxRuns?: number;
     ...
     */
    getObjective(options: {
        threadId: string;
    }): Promise<GoalObjectiveRecord | undefined>;
    /**
     * Drop the objective for a thread.
     */
    clearObjective(options: {
        threadId: string;
    }): Promise<void>;
    /**
    ...
    get voice(): MastraVoice<unknown, unknown, unknown, import("../_types/@internal_voice/dist/index.d.ts").ToolsInput, import("../_types/@internal_voice/dist/index.d.ts").VoiceEventMap, unknown>;
    /**
    ...
    getVoice({ requestContext }?: {
        requestContext?: RequestContext;
    }): Promise<MastraVoice<unknown, unknown, unknown, import("../_types/@internal_voice/dist/index.d.ts").ToolsInput, import("../_types/@internal_voice/dist/index.d.ts").VoiceEventMap, unknown>>;
    /**
     ...
     * @internal
     */
    __getEditorConfig(): AgentEditorConfig | undefined;
    /**
     ...
     */
    sendMessage<OUTPUT = TOutput>(message: AgentMessageInput, target: SendAgentMessageOptions<OUTPUT>): SendAgentMessageResult;
    /**
     * @experimental Agent message APIs are experimental and may change in a future release.
     */
    queueMessage<OUTPUT = TOutput>(message: AgentMessageInput, target: QueueAgentMessageOptions<OUTPUT>): QueueAgentMessageResult;
    /**
     * @experimental Agent state signal APIs are experimental and may change in a future release.
     */
    sendStateSignal<OUTPUT = TOutput>(state: AgentStateSignalInput, target: SendAgentStateSignalOptions<OUTPUT>): Promise<SendAgentStateSignalResult>;
    /**
     * @experimental Agent notification signal APIs are experimental and may change in a future release.
     */
    sendNotificationSignal<OUTPUT = TOutput>(notification: SendNotificationSignalInput, target: SendAgentNotificationSignalOptions<OUTPUT>): Promise<SendAgentNotificationSignalResult>;
    sendNotificationSignal<OUTPUT = TOutput>(notification: SendNotificationSignalInput[], target: SendAgentNotificationSignalOptions<OUTPUT>): Promise<SendAgentNotificationSignalResult[]>;
    /**
     * @experimental Agent signals are experimental and may change in a future release.
     */
    ...
    sendToolApproval<OUTPUT = undefined>(options: AgentExecutionOptions<OUTPUT> & {
        threadId: string;
        resourceId: string;
        toolCallId?: string;
        approved: boolean;
