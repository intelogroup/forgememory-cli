...
var chunkPWQW5NYR_cjs = require('./chunk-PWQW5NYR.cjs');
    ...
    outputStream = new ReadableStream({
      async start(controller) {
        try {
          ...
          chunkYLB2YBKQ_cjs.attachModelStreamTransport(outputStream, chunkYLB2YBKQ_cjs.readModelStreamTransport(stream));
...
var ObjectFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const { value: currentObjectJson, state } = await chunkPWQW5NYR_cjs.parsePartialJson(processedAccumulatedText);
    if (this.validatePartialChunks && this.partialSchema) {
      const result = this.partialSchema?.safeParse(currentObjectJson);
      if (result.success && result.data && result.data !== void 0 && !chunkPWQW5NYR_cjs.isDeepEqualData(previousObject, result.data)) {
        return {
          shouldEmit: true,
    ...
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !chunkPWQW5NYR_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      return {
  ...
  async validateAndTransformFinal(finalRawValue) {
    ...
    const { value } = await chunkPWQW5NYR_cjs.parsePartialJson(rawValue);
...
var ArrayFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson, state: parseState } = await chunkPWQW5NYR_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && !chunkPWQW5NYR_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
      ...
      if (!chunkPWQW5NYR_cjs.isDeepEqualData(this.textPreviousFilteredArray, filteredElements)) {
...
var EnumFormatHandler = class extends BaseFormatHandler {
  ...
  async processPartialChunk({
    ...
    const processedAccumulatedText = this.preprocessText(accumulatedText);
    const { value: currentObjectJson } = await chunkPWQW5NYR_cjs.parsePartialJson(processedAccumulatedText);
    if (currentObjectJson !== void 0 && currentObjectJson !== null && typeof currentObjectJson === "object" && !Array.isArray(currentObjectJson) && "result" in currentObjectJson && typeof currentObjectJson.result === "string" && !chunkPWQW5NYR_cjs.isDeepEqualData(previousObject, currentObjectJson)) {
  ...
  async validateAndTransformFinal(rawFinalValue) {
    ...
    const { value } = await chunkPWQW5NYR_cjs.parsePartialJson(processedValue);
...
var MastraModelOutput = class extends chunkWSD4JNMB_cjs.MastraBase {
          ...
          async transform(chunk, controller) {
            if (chunk.type === "finish" && chunk.payload?.stepResult?.reason === "tool-calls") {
              ...
              const {
                ...
                chunk,
                processorStates,
                chunkFHPG32XN_cjs.resolveObservabilityContext(options),
            ...
            case "finish":
              ...
              try {
                if (self.processorRunner && !self.#options.isLLMExecutionStep) {
                  ...
                  const outputText = lastResponseMessage ? chunk2TATDSHU_cjs.coreContentToString(lastResponseMessage.content) : "";
                ...
                if (error2 instanceof TripWire) {
                  ...
                  self.#error = chunkXSOONORA_cjs.getErrorFromUnknown(error2, {
              ...
              break;
            case "error":
              const error = chunkXSOONORA_cjs.getErrorFromUnknown(chunk.payload.error, {
  ...
  updateUsageCount(usage) {
    ...
    if (usage.cacheCreationInputTokens !== void 0) {
      this.#usageCount.cacheCreationInputTokens = (this.#usageCount.cacheCreationInputTokens ?? 0) + usage.cacheCreationInputTokens;
    }
    if (usage.raw !== void 0) {
  ...
  populateUsageCount(usage) {
    ...
    if (usage.cacheCreationInputTokens !== void 0 && this.#usageCount.cacheCreationInputTokens === void 0) {
      this.#usageCount.cacheCreationInputTokens = usage.cacheCreationInputTokens;
    }
    if (usage.raw !== void 0 && this.#usageCount.raw === void 0) {
      this.#usageCount.raw = usage.raw;
    }
  }
  ...
  #getTotalUsage() {
    ...
    return {
      ...
      ...this.#usageCount.raw !== void 0 && { raw: this.#usageCount.raw }
    };
  }
  #createAbortedOnFinishPayload() {
    return {
      ...
      response: {},
      steps: [],
      totalUsage: { inputTokens: void 0, outputTokens: void 0, totalTokens: void 0 },
      object: void 0
    };
  }
  #createSuspendedOnFinishPayload(chunk) {
    return {
      finishReason: "suspended",
...
var getModelOutputForTripwire = async ({
  ...
  const observabilityContext = chunkFHPG32XN_cjs.resolveObservabilityContext(rest);
...
// src/processors/is-processor-workflow.ts
function isProcessorWorkflow(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && "inputSchema" in obj && "outputSchema" in obj && "execute" in obj && typeof obj.execute === "function" && !("processInput" in obj) && !("processInputStep" in obj) && !("processOutputStream" in obj) && !("processOutputResult" in obj) && !("processOutputStep" in obj) && !("processLLMRequest" in obj) && !("processAPIError" in obj);
}

// src/processors/span-payload.ts
...
function summarizeProcessorModelForSpan(value) {
  ...
  if (modelId === void 0 && provider === void 0 && specificationVersion === void 0) {
    return void 0;
  }
  return {
...
function resolveToolInRegistry(toolRegistry, toolKey) {
  return toolRegistry.find(
    (candidate) => candidate.summary.id === toolKey || candidate.summary.name === toolKey || candidate.registryKey === toolKey
  );
}
function summarizeActiveToolsForSpan(activeTools, tools) {
  ...
  const summaries = activeTools.map((tool) => {
...
// src/processors/stream-reprocess.ts
var REPROCESS_PART_KEY = "__mastraReprocessPart";
...
var ProcessorState = class {
  ...
  constructor(options) {
    ...
    this.span = parentSpan?.createChildSpan({
      ...
      entityType: chunkLP4WZA6D_cjs.EntityType.OUTPUT_PROCESSOR,
...
function areProcessorMessageArraysEqual(before, after) {
  ...
  return before.length === after.length && before.every((message, index) => chunk2TATDSHU_cjs.messagesAreEqual(message, after[index]));
}
function createProcessorSendSignal(args) {
  return async (signalInput) => {
    const signal = chunk2TATDSHU_cjs.createSignal(signalInput);
...
function buildProcessInputStepSpanOutput(args) {
  ...
  if (args.result.retryCount !== void 0) {
...
var ProcessorRunner = class _ProcessorRunner {
  ...
  async runComputeStateSignal({
    ...
    const trackingById = chunk62FISUTS_cjs.getStateSignalsMetadata(thread.metadata);
    const tracking = trackingById[stateId];
    const { activeStateSignals, contextWindow, lastSnapshot, deltasSinceSnapshot } = await chunk62FISUTS_cjs.resolveStateSignalHistory({
      messageList,
    ...
    const result = await computeStateSignal({
      ...
      sendStateSignal: async (stateSignal) => {
        const sendResult = await chunk62FISUTS_cjs.applyStateSignal({
          input: stateSignal,
          memory: resolvedMemory,
          thread,
          resourceId: resolvedResourceId,
    ...
    if (!result) return;
    await chunk62FISUTS_cjs.applyStateSignal({
      input: result,
      memory: resolvedMemory,
      thread,
      resourceId: resolvedResourceId,
  ...
  async runWorkflowComputeStateSignals({
    workflow,
    messageList,
    stepNumber,
    steps,
    ...
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      try {
        ...
        const processResult = await processMethod({
          ...
          abort,
          ...chunkFHPG32XN_cjs.createObservabilityContext({ currentSpan: processorSpan }),
          requestContext,
          retryCount,
          writer,
        ...
        if (processResult instanceof chunk2TATDSHU_cjs.MessageList) {
        ...
        try {
          if (processor.processOutputStream && processedPart) {
            ...
            const result = await processor.processOutputStream({
              ...
              ...chunkFHPG32XN_cjs.createObservabilityContext({ currentSpan: state.span }),
              requestContext,
              messageList,
              retryCount,
              writer
  ...
  async runInputProcessors(messageList, observabilityContext, requestContext, retryCount = 0) {
    for (const [index, processorOrWorkflow] of this.inputProcessors.entries()) {
      ...
      const check = messageList.makeMessageSourceChecker();
      if (isProcessorWorkflow(processorOrWorkflow)) {
        const currentSystemMessages2 = messageList.getSystemMessages();
        await this.executeWorkflowAsProcessor(
          processorOrWorkflow,
          {
            phase: "input",
      ...
      const processorSpan = parentSpan?.createChildSpan({
        ...
        entityType: chunkLP4WZA6D_cjs.EntityType.INPUT_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
      ...
      try {
        ...
        let mutations;
        if (result instanceof chunk2TATDSHU_cjs.MessageList) {
  ...
  async runProcessInputStep(args) {
    ...
    const observabilityContext = chunkFHPG32XN_cjs.resolveObservabilityContext(args);
    const stepInput = {
    ...
    for (const [index, processorOrWorkflow] of processors.entries()) {
      ...
      const processorSpan = currentSpan?.createChildSpan({
        ...
        entityType: chunkLP4WZA6D_cjs.EntityType.INPUT_STEP_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
      ...
      try {
        ...
        const processMethodArgs = {
          ...
          sendStateSignal: async (stateSignal) => {
            ...
            const result2 = await chunk62FISUTS_cjs.applyStateSignal({
              input: stateSignal,
              memory: resolvedMemory,
              thread,
              resourceId: resolvedResourceId,
            ...
            return result2.skipped ? result2 : result2.signal;
          }
        };
        const result = processMethod ? await _ProcessorRunner.validateAndFormatProcessInputStepResult(await processMethod(processMethodArgs), {
          messageList,
          processor,
          stepNumber
        }) : {};
  ...
  async runProcessLLMRequest(args) {
    chunkFHPG32XN_cjs.resolveObservabilityContext({ tracingContext: args.tracingContext });
    ...
    for (const processorOrWorkflow of this.inputProcessors) {
      ...
      try {
        ...
        const result = await processMethod({
          ...
          abortSignal: args.abortSignal,
          writer: args.writer,
          ...chunkFHPG32XN_cjs.createObservabilityContext(args.tracingContext)
        });
  ...
  async runProcessOutputStep(args) {
    ...
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      const processorSpan = parentSpan?.createChildSpan({
        ...
        entityType: chunkLP4WZA6D_cjs.EntityType.OUTPUT_STEP_PROCESSOR,
        entityId: processor.id,
        entityName: processor.name,
        attributes: {
          processorExecutor: "legacy",
      ...
      try {
        ...
        processorSpan?.end({
          output: {
            ...!areProcessorMessageArraysEqual(processableMessages, messageList.get.all.db()) ? { messages: messageList.get.all.db() } : {},
            ...!areProcessorMessageArraysEqual(currentSystemMessages, messageList.getSystemMessages()) ? { systemMessages: messageList.getSystemMessages() } : {}
          },
          attributes: mutations.length > 0 ? { messageListMutations: mutations } : void 0
        });
      } catch (error) {
  ...
  static async validateAndFormatProcessInputStepResult(result, {
    ...
    if (result instanceof chunk2TATDSHU_cjs.MessageList) {
      ...
      if (result.model) {
        const resolvedModel = await chunkYLB2YBKQ_cjs.resolveModelConfig(result.model);
...
exports.MastraModelInput = MastraModelInput;
exports.MastraModelOutput = MastraModelOutput;
exports.ProcessorRunner = ProcessorRunner;
exports.ProcessorState = ProcessorState;
exports.REPROCESS_PART_KEY = REPROCESS_PART_KEY;
exports.TripWire = TripWire;
exports.createDestructurableOutput = createDestructurableOutput;
exports.createProcessorSendSignal = createProcessorSendSignal;
exports.escapeUnescapedControlCharsInJsonStrings = escapeUnescapedControlCharsInJsonStrings;
exports.getModelOutputForTripwire = getModelOutputForTripwire;
...
exports.safeEnqueue = safeEnqueue;
exports.summarizeActiveToolsForSpan = summarizeActiveToolsForSpan;
exports.summarizeProcessorModelForSpan = summarizeProcessorModelForSpan;
exports.summarizeProcessorResultForSpan = summarizeProcessorResultForSpan;
exports.summarizeProcessorToolsForSpan = summarizeProcessorToolsForSpan;
exports.summarizeToolChoiceForSpan = summarizeToolChoiceForSpan;
...
//# sourceMappingURL=chunk-UHTO5JDE.cjs.map
//# sourceMappingURL=chunk-UHTO5JDE.cjs.map