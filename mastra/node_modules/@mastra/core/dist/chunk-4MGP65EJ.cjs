...
var PromptBlocksStorage = class extends chunk7Q5UQ5ES_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      blocks = blocks.filter((block) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunk3KZ2OT53_cjs.deepEqual(block.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-4MGP65EJ.cjs.map
//# sourceMappingURL=chunk-4MGP65EJ.cjs.map