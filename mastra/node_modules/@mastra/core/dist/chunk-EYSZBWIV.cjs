...
var MCPClientsStorage = class extends chunk7Q5UQ5ES_cjs.VersionedStorageDomain {
  listKey = "mcpClients";
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      configs = configs.filter((config) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunk3KZ2OT53_cjs.deepEqual(config.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-EYSZBWIV.cjs.map
//# sourceMappingURL=chunk-EYSZBWIV.cjs.map