...
function splitRuntimeModelString(input) {
  const providers = chunkRWB3UEF4_cjs.getRegisteredProviders().sort((a, b) => b.length - a.length);
  ...
  const parsed = chunkRWB3UEF4_cjs.parseModelString(input);
...
function isModelAllowed(allowed, candidate) {
  ...
  const activeEntries = allowed.filter((entry) => {
    ...
    return chunkRWB3UEF4_cjs.isProviderRegistered(entry.provider);
  });
...
exports.BUILDER_FEATURE_DEFAULTS = BUILDER_FEATURE_DEFAULTS;
exports.MODEL_NOT_ALLOWED_CODE = MODEL_NOT_ALLOWED_CODE;
exports.ModelNotAllowedError = ModelNotAllowedError;
exports.assertModelAllowed = assertModelAllowed;
exports.builderToModelPolicy = builderToModelPolicy;
exports.enforceModelAllowlist = enforceModelAllowlist;
exports.isBuilderModelPolicyActive = isBuilderModelPolicyActive;
exports.isModelAllowed = isModelAllowed;
exports.isModelNotAllowedError = isModelNotAllowedError;
exports.matchesProvider = matchesProvider;
exports.resolveAgentFeatures = resolveAgentFeatures;
exports.resolvePickerVisibility = resolvePickerVisibility;
exports.toModelCandidates = toModelCandidates;
