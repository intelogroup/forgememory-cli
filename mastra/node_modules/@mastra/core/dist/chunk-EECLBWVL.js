import { ModelsDevGateway, createOpenRouter } from './chunk-YITQGZN2.js';
import { NetlifyGateway } from './chunk-BNTVRJW3.js';
import { createJsonErrorResponseHandler, lazyValidator, zodSchema, lazySchema, createProviderDefinedToolFactoryWithOutputSchema, MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER, MASTRA_GATEWAY_STREAM_TRANSPORT, parseProviderOptions, postJsonToApi, createJsonResponseHandler, combineHeaders, generateId, createEventSourceResponseHandler, InvalidResponseDataError, isParsableJson, TooManyEmbeddingValuesForCallError, APICallError, convertBase64ToUint8Array, mediaTypeToExtension, postFormDataToApi, createBinaryResponseHandler, loadApiKey, withUserAgentSuffix, convertToBase64, UnsupportedFunctionalityError, InvalidPromptError, validateTypes, loadSetting } from './chunk-GWNNROVX.js';
...
var openaiImageModelGenerationOptions = lazyValidator(
  () => zodSchema(
...
var GLOBAL_CAPABILITIES_DIR = () => path.join(CACHE_DIR(), "capabilities");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-CAFR577S.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-KJTFJQYG.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-EB7TE6GA.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-NMZIIKDC.js');
...
export { AzureOpenAIGateway, GatewayRegistry, MastraGateway, PROVIDER_MODELS, PROVIDER_REGISTRY, createOpenAIWebSocketFetch, findGatewayForModel, getGatewayId, getProviderConfig, getRegisteredProviders, isOfflineMode, isProviderRegistered, isValidModelId, modelSupportsAttachments, parseModelString, shouldEnableGateway };
//# sourceMappingURL=chunk-EECLBWVL.js.map
//# sourceMappingURL=chunk-EECLBWVL.js.map