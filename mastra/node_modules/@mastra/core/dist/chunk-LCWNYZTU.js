import { standardSchemaToJSONSchema, toStandardSchema } from './chunk-6SRTDZ7S.js';
import { unwrapZodType, isZodObject, getZodTypeName, isZodArray } from './chunk-TBHKQLPL.js';
...
var Tool = class {
  ...
  constructor(opts) {
    ...
    this.inputSchema = opts.inputSchema ? toStandardSchema(opts.inputSchema) : void 0;
    this.outputSchema = opts.outputSchema ? toStandardSchema(opts.outputSchema) : void 0;
    this.suspendSchema = opts.suspendSchema ? toStandardSchema(opts.suspendSchema) : void 0;
    this.resumeSchema = opts.resumeSchema ? toStandardSchema(opts.resumeSchema) : void 0;
...
export { MASTRA_TOOL_MARKER, Tool, createTool, getNeedsApprovalFn, getProviderToolName, isMastraTool, isProviderDefinedTool, isProviderTool, isValidationError, isVercelTool, validateToolInput, validateToolOutput, validateToolSuspendData };
//# sourceMappingURL=chunk-LCWNYZTU.js.map
//# sourceMappingURL=chunk-LCWNYZTU.js.map