import { createJsonErrorResponseHandler2, lazySchema2, zodSchema2, lazySchema, zodSchema, createProviderToolFactory, createProviderToolFactoryWithOutputSchema, withoutTrailingSlash2, withoutTrailingSlash, OpenAICompatibleChatLanguageModel, generateId2, parseProviderOptions2, postJsonToApi2, createJsonResponseHandler2, combineHeaders2, createEventSourceResponseHandler2, InvalidResponseDataError2, isParsableJson2, withUserAgentSuffix2, loadApiKey2, withUserAgentSuffix, loadApiKey, createJsonErrorResponseHandler, parseProviderOptions, postJsonToApi, createJsonResponseHandler, combineHeaders, generateId, createEventSourceResponseHandler, InvalidResponseDataError, isParsableJson, injectJsonInstructionIntoMessages, APICallError2 as APICallError2$1, extractResponseHeaders, safeParseJSON, UnsupportedFunctionalityError2, UnsupportedFunctionalityError, convertToBase642, NoSuchModelError2, NoSuchModelError, OpenAICompatibleCompletionLanguageModel, OpenAICompatibleEmbeddingModel, MastraModelGateway, EXCLUDED_PROVIDERS, PROVIDERS_WITH_INSTALLED_PACKAGES, MASTRA_USER_AGENT, createAnthropic, createOpenAI, createGoogleGenerativeAI, createOpenAICompatible, convertUint8ArrayToBase642, resolve2, AISDKError, delay, getFromApi, TooManyEmbeddingValuesForCallError2, convertBase64ToUint8Array2, mediaTypeToExtension2, postFormDataToApi2, convertImageModelFileToDataUri, createBinaryResponseHandler2, createStatusCodeErrorResponseHandler, validateTypes2 as validateTypes2$1, convertUint8ArrayToBase64 } from './chunk-GWNNROVX.js';
import { createGatewayProvider } from './chunk-TOBPSKTN.js';
...
var alibabaErrorDataSchema = z.object({
  error: z.object({
    message: z.string(),
...
function formatImageUrl({
  ...
  return data instanceof URL ? data.toString() : `data:${mediaType};base64,${convertToBase642(data)}`;
}
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
...
var alibabaVideoModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    z.object({
...
var alibabaVideoErrorSchema = z.object({
  code: z.string().nullish(),
  message: z.string(),
...
function createAlibaba(options = {}) {
  var _a15, _b;
  const baseURL = (_a15 = withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
  const videoBaseURL = (_b = withoutTrailingSlash2(options.videoBaseURL)) != null ? _b : "https://dashscope-intl.aliyuncs.com";
...
var groqTranscriptionModelOptions = lazySchema2(
  () => zodSchema2(
    z.object({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => withUserAgentSuffix2(
    {
      Authorization: `Bearer ${loadApiKey2({
        apiKey: options.apiKey,
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await postJsonToApi2({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        ...
        return createEventSourceResponseHandler2(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await validateTypes2$1({
            value: tool.args,
...
var modeSchema = z.enum(["edit-video", "extend-video", "reference-to-video"]);
var baseFields = {
  pollIntervalMs: z.number().positive().nullish(),
  pollTimeoutMs: z.number().positive().nullish(),
...
var xaiVideoModelOptionsSchema = lazySchema2(
  () => zodSchema2(runtimeSchema)
);
var RESOLUTION_MAP = {
  "1280x720": "720p",
  "854x480": "480p",
...
var xaiCreateVideoResponseSchema = z.object({
  request_id: z.string().nullish()
});
var xaiVideoStatusResponseSchema = z.object({
...
var ModelsDevGateway = class extends MastraModelGateway {
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      ...
      case "vercel":
        return createGatewayProvider({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
...
export { ModelsDevGateway, createOpenRouter, parseModelRouterId };
//# sourceMappingURL=chunk-YITQGZN2.js.map
//# sourceMappingURL=chunk-YITQGZN2.js.map