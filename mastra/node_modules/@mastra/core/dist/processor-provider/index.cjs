...
var structuredOutputOptionsSchema = v4.z.object({ jsonPromptInjection: v4.z.boolean().optional() }).optional();
var providerOptionsSchema = v4.z.record(v4.z.string(), v4.z.any()).optional();
var unicodeNormalizerProvider = {
  ...
  configSchema: v4.z.object({
    stripControlChars: v4.z.boolean().optional(),
    preserveEmojis: v4.z.boolean().optional(),
    collapseWhitespace: v4.z.boolean().optional(),
    trim: v4.z.boolean().optional()
  }),
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  configSchema: v4.z.object({
    limit: v4.z.number(),
    strategy: v4.z.enum(["truncate", "abort"]).optional(),
    countMode: v4.z.enum(["cumulative", "part"]).optional()
  }),
  availablePhases: ["processInput", "processOutputStream", "processOutputResult"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  configSchema: v4.z.object({
    exclude: v4.z.array(v4.z.string()).optional(),
    filterAfterToolSteps: v4.z.number().optional(),
    preserveModelOutput: v4.z.boolean().optional()
  }),
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  configSchema: v4.z.object({
    batchSize: v4.z.number().optional(),
    maxWaitTime: v4.z.number().optional(),
    emitOnNonText: v4.z.boolean().optional()
  }),
  availablePhases: ["processOutputStream"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  configSchema: v4.z.object({
    model: v4.z.string(),
    categories: v4.z.array(v4.z.string()).optional(),
    threshold: v4.z.number().optional(),
    strategy: v4.z.enum(["block", "warn", "filter"]).optional(),
    instructions: v4.z.string().optional(),
    includeScores: v4.z.boolean().optional(),
    chunkWindow: v4.z.number().optional(),
  ...
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  configSchema: v4.z.object({
    model: v4.z.string(),
    detectionTypes: v4.z.array(v4.z.string()).optional(),
    threshold: v4.z.number().optional(),
    strategy: v4.z.enum(["block", "warn", "filter", "rewrite"]).optional(),
    instructions: v4.z.string().optional(),
    includeScores: v4.z.boolean().optional(),
    structuredOutputOptions: structuredOutputOptionsSchema,
    providerOptions: providerOptionsSchema
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  configSchema: v4.z.object({
    ...
    detectionTypes: v4.z.array(v4.z.string()).optional(),
    threshold: v4.z.number().optional(),
    strategy: v4.z.enum(["block", "warn", "filter", "redact"]).optional(),
    redactionMethod: v4.z.enum(["mask", "hash", "remove", "placeholder"]).optional(),
    instructions: v4.z.string().optional(),
    includeDetections: v4.z.boolean().optional(),
    preserveFormat: v4.z.boolean().optional(),
    structuredOutputOptions: structuredOutputOptionsSchema,
    providerOptions: providerOptionsSchema
  }),
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  configSchema: v4.z.object({
    model: v4.z.string(),
    targetLanguages: v4.z.array(v4.z.string()),
    threshold: v4.z.number().optional(),
    strategy: v4.z.enum(["detect", "translate", "block", "warn"]).optional(),
    preserveOriginal: v4.z.boolean().optional(),
    instructions: v4.z.string().optional(),
    minTextLength: v4.z.number().optional(),
    includeDetectionDetails: v4.z.boolean().optional(),
    translationQuality: v4.z.enum(["speed", "quality", "balanced"]).optional(),
    providerOptions: providerOptionsSchema
  }),
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  configSchema: v4.z.object({
    model: v4.z.string(),
    strategy: v4.z.enum(["block", "warn", "filter", "redact"]).optional(),
    customPatterns: v4.z.array(v4.z.string()).optional(),
    includeDetections: v4.z.boolean().optional(),
    instructions: v4.z.string().optional(),
    redactionMethod: v4.z.enum(["mask", "placeholder", "remove"]).optional(),
    placeholderText: v4.z.string().optional(),
    structuredOutputOptions: structuredOutputOptionsSchema
  }),
  availablePhases: ["processOutputStream", "processOutputResult"],
  createProcessor(config) {
    return new chunk6ZBUYPOD_cjs.SystemPromptScrubber(config);
  }
};
