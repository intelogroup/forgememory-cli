 ...
 * lane.
 */
export declare abstract class ThreadStateStorage extends MastraBase {
    constructor();
    /**
     ...
     */
    abstract getState<T = unknown>(args: {
        threadId: string;
        type: string;
    }): Promise<T | undefined>;
    /**
     ...
     */
    abstract setState<T = unknown>(args: {
        threadId: string;
        type: string;
        value: T;
    }): Promise<void>;
