...
var spec_star = require('@standard-schema/spec');
...
var spec_star__namespace = /*#__PURE__*/_interopNamespace(spec_star);
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/provider-utils/3.0.25/8850a22427892148bad3177fddb9b16cacd9df1673e18e8f590fecb805b79a5c/node_modules/@ai-sdk/provider-utils/dist/index.mjs
var dist_exports = {};
chunkBVWXTWXP_cjs.__export(dist_exports, {
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/provider-utils/3.0.25/8850a22427892148bad3177fddb9b16cacd9df1673e18e8f590fecb805b79a5c/node_modules/@ai-sdk/provider-utils/dist/index.mjs
chunkBVWXTWXP_cjs.__reExport(dist_exports, spec_star__namespace);
...
function parseArrayDef(def, refs) {
  ...
  if (((_a23 = def.type) == null ? void 0 : _a23._def) && ((_c = (_b23 = def.type) == null ? void 0 : _b23._def) == null ? void 0 : _c.typeName) !== v3.ZodFirstPartyTypeKind.ZodAny) {
...
function addFormat(schema, value, message, refs) {
  var _a23;
  if (schema.format || ((_a23 = schema.anyOf) == null ? void 0 : _a23.some((x) => x.format))) {
    if (!schema.anyOf) {
      schema.anyOf = [];
    }
    if (schema.format) {
...
function addPattern(schema, regex, message, refs) {
  var _a23;
  if (schema.pattern || ((_a23 = schema.allOf) == null ? void 0 : _a23.some((x) => x.pattern))) {
    if (!schema.allOf) {
      schema.allOf = [];
    }
    if (schema.pattern) {
      ...
      if (inCharGroup) {
        if (source[i].match(/[a-z]/)) {
          if (inCharRange) {
            ...
            inCharRange = false;
          } else if (source[i + 1] === "-" && ((_a23 = source[i + 2]) == null ? void 0 : _a23.match(/[a-z]/))) {
            pattern += source[i];
            inCharRange = true;
          } else {
...
function parseRecordDef(def, refs) {
  ...
  if (((_b23 = def.keyType) == null ? void 0 : _b23._def.typeName) === v3.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
...
var parseOptionalDef = (def, refs) => {
  var _a23;
  if (refs.currentPath.toString() === ((_a23 = refs.propertyPath) == null ? void 0 : _a23.toString())) {
    return parseDef(def.innerType._def, refs);
  }
...
function parseDef(def, refs, forceResolution = false) {
  ...
  if (refs.override) {
    const overrideResult = (_a23 = refs.override) == null ? void 0 : _a23.call(
      refs,
      def,
      refs,
      seenItem,
...
var getRefs = (options) => {
  ...
  return {
    ...
    propertyPath: void 0,
    seen: new Map(
      Object.entries(_options.definitions).map(([name23, def]) => [
        def._def,
        {
          def: def._def,
          path: [..._options.basePath, _options.definitionPath, name23],
...
var zodToJsonSchema = (schema, options) => {
  ...
  const name23 = typeof options === "string" ? options : (options == null ? void 0 : options.nameStrategy) === "title" ? void 0 : options == null ? void 0 : options.name;
  const main = (_a23 = parseDef(
    schema._def,
    name23 === void 0 ? refs : {
      ...refs,
  ...
  const combined = name23 === void 0 ? definitions ? {
    ...main,
...
function getOpenAIMetadata(message) {
  var _a18, _b18;
  return (_b18 = (_a18 = message == null ? void 0 : message.providerOptions) == null ? void 0 : _a18.openaiCompatible) != null ? _b18 : {};
}
...
var openaiCompatibleProviderOptions = z4.z.object({
  /**
   ...
   */
  reasoningEffort: z4.z.string().optional(),
  /**
   * Controls the verbosity of the generated text. Defaults to `medium`.
   */
  textVerbosity: z4.z.string().optional()
});
var openaiCompatibleErrorDataSchema = z4.z.object({
  error: z4.z.object({
    message: z4.z.string(),
...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, config) {
    ...
    this.supportsStructuredOutputs = (_b18 = config.supportsStructuredOutputs) != null ? _b18 : false;
  }
  get provider() {
  ...
  convertUsage(usage) {
    var _a18, _b18, _c;
    return (_c = (_b18 = (_a18 = this.config).convertUsage) == null ? void 0 : _b18.call(_a18, usage)) != null ? _c : convertOpenAICompatibleChatUsage(usage);
  }
  async getArgs({
    prompt,
    maxOutputTokens,
      ...
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a23, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
            ...
            const reasoningContent = (_a23 = delta.reasoning_content) != null ? _a23 : delta.reasoning;
            if (reasoningContent) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_b18 = toolCallDelta.function) == null ? void 0 : _b18.name) == null) {
                    throw new InvalidResponseDataError({
                      data: toolCallDelta,
...
var openaiCompatibleTokenUsageSchema = z4.z.object({
...
function convertOpenAICompatibleChatUsage(usage) {
  ...
  return {
    ...
    outputTokens: (_b18 = usage == null ? void 0 : usage.completion_tokens) != null ? _b18 : void 0,
...
var OpenAICompatibleChatResponseSchema = z4.z.object({
...
var createOpenAICompatibleChatChunkSchema = (errorSchema) => z4.z.union([
  z4.z.object({
    id: z4.z.string().nullish(),
    created: z4.z.number().nullish(),
    model: z4.z.string().nullish(),
...
var openaiCompatibleCompletionProviderOptions = z4.z.object({
  /**
...
var OpenAICompatibleCompletionLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      content,
      usage: {
        inputTokens: (_b18 = (_a18 = response.usage) == null ? void 0 : _a18.prompt_tokens) != null ? _b18 : void 0,
...
var usageSchema = z4.z.object({
  prompt_tokens: z4.z.number(),
  completion_tokens: z4.z.number(),
  total_tokens: z4.z.number()
});
var openaiCompatibleCompletionResponseSchema = z4.z.object({
  id: z4.z.string().nullish(),
  created: z4.z.number().nullish(),
  model: z4.z.string().nullish(),
  choices: z4.z.array(
...
var createOpenAICompatibleCompletionChunkSchema = (errorSchema) => z4.z.union([
  z4.z.object({
    id: z4.z.string().nullish(),
    created: z4.z.number().nullish(),
    model: z4.z.string().nullish(),
...
var openaiCompatibleEmbeddingProviderOptions = z4.z.object({
  /**
...
var openaiTextEmbeddingResponseSchema = z4.z.object({
  data: z4.z.array(z4.z.object({ embedding: z4.z.array(z4.z.number()) })),
  usage: z4.z.object({ prompt_tokens: z4.z.number() }).nullish(),
  providerMetadata: z4.z.record(z4.z.string(), z4.z.record(z4.z.string(), z4.z.any())).optional()
});
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/provider/3.0.10/0a7346fe2d918129694b7a3854f60556297703876a7eb06af86e8f8dfed8a65f/node_modules/@ai-sdk/provider/dist/index.mjs
var marker16 = "vercel.ai.error";
var symbol16 = Symbol.for(marker16);
var _a16;
var _b16;
var AISDKError2 = class _AISDKError2 extends (_b16 = Error, _a16 = symbol16, _b16) {
  /**
   * Creates an AI SDK Error.
   *
   * @param {Object} params - The parameters for creating the error.
   ...
   */
  static isInstance(error) {
    return _AISDKError2.hasMarker(error, marker16);
  }
  static hasMarker(error, marker152) {
    const markerSymbol = Symbol.for(marker152);
    return error != null && typeof error === "object" && markerSymbol in error && typeof error[markerSymbol] === "boolean" && error[markerSymbol] === true;
...
function createToolNameMapping({
  ...
  for (const tool22 of tools) {
    if (tool22.type === "provider") {
      const providerToolName = (_a23 = resolveProviderToolName == null ? void 0 : resolveProviderToolName(tool22)) != null ? _a23 : tool22.id in providerToolNames ? providerToolNames[tool22.id] : void 0;
  ...
  return {
    toProviderToolName: (customToolName) => {
      var _a33;
      return (_a33 = customToolNameToProviderToolName[customToolName]) != null ? _a33 : customToolName;
    },
    toCustomToolName: (providerToolName) => {
      var _a33;
      return (_a33 = providerToolNameToCustomToolName[providerToolName]) != null ? _a33 : providerToolName;
    }
  };
}
...
function convertImageModelFileToDataUri(file) {
  ...
  return `data:${file.mediaType};base64,${typeof file.data === "string" ? file.data : convertUint8ArrayToBase642(file.data)}`;
}
...
var _a17;
var _b17;
var DownloadError2 = class extends (_b17 = AISDKError2, _a17 = symbol17, _b17) {
  constructor({
    url,
    statusCode,
    statusText,
...
function validateDownloadUrl2(url) {
  let parsed;
  try {
    parsed = new URL(url);
  } catch (e) {
...
async function downloadBlob(url, options) {
  ...
  try {
    ...
    throw new DownloadError2({ url, cause: error });
  }
}
    ...
    (acc, [name33, schema2]) => {
      ...
      return {
        ...
        [name33]: (_a33 = parseDef2(
          ...
          true
        )) != null ? _a33 : parseAnyDef2()
      };
    },
    {}
  ) : void 0;
  const name23 = typeof options === "string" ? options : (options == null ? void 0 : options.nameStrategy) === "title" ? void 0 : options == null ? void 0 : options.name;
  const main = (_a23 = parseDef2(
    schema._def,
    name23 === void 0 ? refs : {
      ...refs,
      currentPath: [...refs.basePath, refs.definitionPath, name23]
...
function asSchema2(schema) {
  return schema == null ? jsonSchema2({ properties: {}, additionalProperties: false }) : isSchema2(schema) ? schema : "~standard" in schema ? schema["~standard"].vendor === "zod" ? zodSchema2(schema) : standardSchema(schema) : schema();
}
...
var createJsonResponseHandler2 = (responseSchema2) => async ({ response, url, requestBodyValues }) => {
  const responseBody = await response.text();
...
var createStatusCodeErrorResponseHandler2 = () => async ({ response, url, requestBodyValues }) => {
  const responseHeaders = extractResponseHeaders2(response);
  const responseBody = await response.text();
  return {
    responseHeaders,
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    image_url: {
                      ...
                      detail: (_b18 = (_a23 = part.providerOptions) == null ? void 0 : _a23.openai) == null ? void 0 : _b18.imageDetail
                    }
                  };
...
var openaiLanguageModelChatOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       * Reasoning effort for reasoning models. Defaults to `medium`.
       */
      reasoningEffort: z4.z.enum(["none", "minimal", "low", "medium", "high", "xhigh"]).optional(),
      /**
       ...
       */
      systemMessageMode: z4.z.enum(["system", "developer", "remove"]).optional(),
      /**
       ...
       */
      forceReasoning: z4.z.boolean().optional()
    })
  )
);
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a18, _b18, _c, _d, _e;
    const warnings = [];
    const openaiOptions = (_a18 = await parseProviderOptions2({
      provider: "openai",
      providerOptions,
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (value.usage != null) {
              usage = value.usage;
              if (((_a18 = value.usage.completion_tokens_details) == null ? void 0 : _a18.accepted_prediction_tokens) != null) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (((_o = toolCall.function) == null ? void 0 : _o.name) != null && ((_p = toolCall.function) == null ? void 0 : _p.arguments) != null && isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
...
var openaiImageResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      ...
      background: z4.z.string().nullish(),
      output_format: z4.z.string().nullish(),
      size: z4.z.string().nullish(),
      quality: z4.z.string().nullish(),
      usage: z4.z.object({
        input_tokens: z4.z.number().nullish(),
        output_tokens: z4.z.number().nullish(),
        total_tokens: z4.z.number().nullish(),
        input_tokens_details: z4.z.object({
          image_tokens: z4.z.number().nullish(),
          text_tokens: z4.z.number().nullish()
        }).nullish()
      }).nullish()
    })
  )
...
var baseImageModelOptionsObject = z4.z.object({
  /**
   * Quality of the generated image(s).
   *
   * Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
   */
  quality: z4.z.enum(["standard", "hd", "low", "medium", "high", "auto"]).optional(),
  /**
   ...
   * (i.e. `png` or `webp`).
   */
  background: z4.z.enum(["transparent", "opaque", "auto"]).optional(),
  /**
...
var openaiImageModelGenerationOptions = lazySchema2(
  () => zodSchema2(
    baseImageModelOptionsObject.extend({
       ...
       * looking images.
       */
      style: z4.z.enum(["vivid", "natural"]).optional(),
      /**
       * Content moderation level for the generated image(s). `low` applies
       * less restrictive filtering.
       */
      moderation: z4.z.enum(["auto", "low"]).optional()
    })
  )
);
var openaiImageModelEditOptions = lazySchema2(
  () => zodSchema2(
    baseImageModelOptionsObject.extend({
      /**
       * Fidelity of the output image(s) to the input image(s).
       */
      inputFidelity: z4.z.enum(["high", "low"]).optional()
    })
  )
);
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k;
    const warnings = [];
    if (aspectRatio != null) {
      warnings.push({
        type: "unsupported",
    ...
    const currentDate = (_c = (_b18 = (_a18 = this.config._internal) == null ? void 0 : _a18.currentDate) == null ? void 0 : _b18.call(_a18)) != null ? _c : /* @__PURE__ */ new Date();
    if (files != null) {
      const openaiOptions2 = (_d = await parseProviderOptions2({
        provider: "openai",
        providerOptions,
    ...
    const openaiOptions = (_h = await parseProviderOptions2({
      provider: "openai",
      providerOptions,
...
var applyPatchInputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      callId: z4.z.string(),
      operation: z4.z.discriminatedUnion("type", [
        z4.z.object({
          type: z4.z.literal("create_file"),
          path: z4.z.string(),
          diff: z4.z.string()
        }),
        z4.z.object({
          type: z4.z.literal("delete_file"),
          path: z4.z.string()
        }),
        z4.z.object({
          type: z4.z.literal("update_file"),
          path: z4.z.string(),
          diff: z4.z.string()
        })
      ])
...
var applyPatchOutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      status: z4.z.enum(["completed", "failed"]),
...
var customArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      name: z4.z.string(),
      description: z4.z.string().optional(),
      format: z4.z.union([
        z4.z.object({
          type: z4.z.literal("grammar"),
          syntax: z4.z.enum(["regex", "lark"]),
          definition: z4.z.string()
        }),
        z4.z.object({
...
var customInputSchema = lazySchema2(() => zodSchema2(z4.z.string()));
...
var comparisonFilterSchema = z4.z.object({
  key: z4.z.string(),
  type: z4.z.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: z4.z.union([z4.z.string(), z4.z.number(), z4.z.boolean(), z4.z.array(z4.z.string())])
});
...
var imageGenerationInputSchema = lazySchema2(() => zodSchema2(z4.z.object({})));
var imageGenerationOutputSchema = lazySchema2(
  () => zodSchema2(z4.z.object({ result: z4.z.string() }))
);
...
var localShellOutputSchema = lazySchema2(
  () => zodSchema2(z4.z.object({ output: z4.z.string() }))
);
...
var shellInputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      action: z4.z.object({
        commands: z4.z.array(z4.z.string()),
        timeoutMs: z4.z.number().optional(),
        maxOutputLength: z4.z.number().optional()
      })
    })
  )
);
    ...
    z4.z.object({
      output: z4.z.array(
        z4.z.object({
          stdout: z4.z.string(),
          stderr: z4.z.string(),
          outcome: z4.z.discriminatedUnion("type", [
            z4.z.object({ type: z4.z.literal("timeout") }),
            z4.z.object({ type: z4.z.literal("exit"), exitCode: z4.z.number() })
          ])
        })
      )
    })
...
var shellSkillsSchema = z4.z.array(
  z4.z.discriminatedUnion("type", [
    z4.z.object({
      type: z4.z.literal("skillReference"),
      skillId: z4.z.string(),
      version: z4.z.string().optional()
    }),
    z4.z.object({
      type: z4.z.literal("inline"),
      name: z4.z.string(),
      description: z4.z.string(),
      source: z4.z.object({
        type: z4.z.literal("base64"),
        mediaType: z4.z.literal("application/zip"),
        data: z4.z.string()
      })
    })
  ])
...
var shellArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      environment: z4.z.union([
        z4.z.object({
          type: z4.z.literal("containerAuto"),
          fileIds: z4.z.array(z4.z.string()).optional(),
          memoryLimit: z4.z.enum(["1g", "4g", "16g", "64g"]).optional(),
          networkPolicy: z4.z.discriminatedUnion("type", [
            z4.z.object({ type: z4.z.literal("disabled") }),
            z4.z.object({
              type: z4.z.literal("allowlist"),
              allowedDomains: z4.z.array(z4.z.string()),
              domainSecrets: z4.z.array(
                z4.z.object({
                  domain: z4.z.string(),
                  name: z4.z.string(),
                  value: z4.z.string()
        ...
        z4.z.object({
          type: z4.z.literal("containerReference"),
          containerId: z4.z.string()
        }),
        z4.z.object({
          type: z4.z.literal("local").optional(),
          skills: z4.z.array(
            z4.z.object({
              name: z4.z.string(),
              description: z4.z.string(),
...
var toolSearchArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      execution: z4.z.enum(["server", "client"]).optional(),
      description: z4.z.string().optional(),
      parameters: z4.z.record(z4.z.string(), z4.z.unknown()).optional()
    })
  )
);
var toolSearchInputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      arguments: z4.z.unknown().optional(),
      call_id: z4.z.string().nullish()
    })
  )
);
var toolSearchOutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      tools: z4.z.array(z4.z.record(z4.z.string(), z4.z.unknown()))
    })
  )
);
...
var webSearchInputSchema = lazySchema2(() => zodSchema2(z4.z.object({})));
    ...
    z4.z.object({
      action: z4.z.discriminatedUnion("type", [
        ...
        z4.z.object({
          ...
          url: z4.z.string().nullish()
        }),
        z4.z.object({
          type: z4.z.literal("findInPage"),
          url: z4.z.string().nullish(),
          pattern: z4.z.string().nullish()
        })
      ]).optional(),
      sources: z4.z.array(
        z4.z.discriminatedUnion("type", [
...
var mcpArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      serverLabel: z4.z.string(),
      allowedTools: z4.z.union([
        z4.z.array(z4.z.string()),
        z4.z.object({
          readOnly: z4.z.boolean().optional(),
          toolNames: z4.z.array(z4.z.string()).optional()
        })
      ]).optional(),
      authorization: z4.z.string().optional(),
      connectorId: z4.z.string().optional(),
      headers: z4.z.record(z4.z.string(), z4.z.string()).optional(),
      requireApproval: z4.z.union([
        z4.z.enum(["always", "never"]),
        z4.z.object({
          never: z4.z.object({
            toolNames: z4.z.array(z4.z.string()).optional()
          }).optional()
      ...
      serverDescription: z4.z.string().optional(),
...
var mcpInputSchema = lazySchema2(() => zodSchema2(z4.z.object({})));
var mcpOutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      type: z4.z.literal("call"),
      serverLabel: z4.z.string(),
      name: z4.z.string(),
      arguments: z4.z.string(),
      output: z4.z.string().nullish(),
      error: z4.z.union([z4.z.string(), jsonValueSchema]).optional()
    })
  )
);
...
function convertOpenAIResponsesUsage(usage) {
  ...
  const cachedTokens = (_b18 = (_a18 = usage.input_tokens_details) == null ? void 0 : _a18.cached_tokens) != null ? _b18 : 0;
    ...
    switch (role) {
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    detail: (_b23 = (_a23 = part.providerOptions) == null ? void 0 : _a23[providerOptionsName]) == null ? void 0 : _b23.imageDetail
                  };
                } else if (part.mediaType === "application/pdf") {
                  if (part.data instanceof URL) {
                    return {
      ...
      case "assistant": {
        ...
        for (const part of content) {
          switch (part.type) {
            case "text": {
              const providerOpts = (_a18 = part.providerOptions) == null ? void 0 : _a18[providerOptionsName];
                  ...
                  switch (item.type) {
                    ...
                    case "image-data":
                      return {
                        ...
                        detail: (_b23 = (_a23 = item.providerOptions) == null ? void 0 : _a23[providerOptionsName]) == null ? void 0 : _b23.imageDetail
                      };
                    case "image-url":
                      return {
                        type: "input_image",
...
var jsonValueSchema2 = z4.z.lazy(
  () => z4.z.union([
    z4.z.string(),
    z4.z.number(),
    z4.z.boolean(),
    z4.z.null(),
    z4.z.array(jsonValueSchema2),
    z4.z.record(z4.z.string(), jsonValueSchema2.optional())
  ])
);
var openaiResponsesChunkSchema = lazySchema2(
  () => zodSchema2(
    z4.z.union([
      ...
      z4.z.object({
        type: z4.z.literal("response.failed"),
        response: z4.z.object({
          error: z4.z.object({
            code: z4.z.string().nullish(),
            message: z4.z.string()
      ...
      z4.z.object({
        ...
        item: z4.z.discriminatedUnion("type", [
          z4.z.object({
            ...
            id: z4.z.string(),
            phase: z4.z.enum(["commentary", "final_answer"]).nullish()
          }),
          z4.z.object({
          ...
          z4.z.object({
            type: z4.z.literal("mcp_call"),
            id: z4.z.string(),
            status: z4.z.string(),
            approval_request_id: z4.z.string().nullish()
          }),
          z4.z.object({
            type: z4.z.literal("mcp_list_tools"),
            id: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("mcp_approval_request"),
            id: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("apply_patch_call"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            status: z4.z.enum(["in_progress", "completed"]),
            operation: z4.z.discriminatedUnion("type", [
              z4.z.object({
                type: z4.z.literal("create_file"),
                path: z4.z.string(),
          ...
          z4.z.object({
            type: z4.z.literal("custom_tool_call"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            name: z4.z.string(),
            input: z4.z.string()
          ...
          z4.z.object({
            type: z4.z.literal("shell_call"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            status: z4.z.enum(["in_progress", "completed", "incomplete"]),
            action: z4.z.object({
              commands: z4.z.array(z4.z.string())
            })
          }),
          z4.z.object({
            type: z4.z.literal("shell_call_output"),
            id: z4.z.string(),
            call_id: z4.z.string(),
            status: z4.z.enum(["in_progress", "completed", "incomplete"]),
            output: z4.z.array(
              z4.z.object({
                ...
                outcome: z4.z.discriminatedUnion("type", [
                  z4.z.object({ type: z4.z.literal("timeout") }),
                  z4.z.object({
                    type: z4.z.literal("exit"),
                    exit_code: z4.z.number()
                  })
                ])
              })
            )
          ...
          z4.z.object({
            type: z4.z.literal("tool_search_call"),
            id: z4.z.string(),
            execution: z4.z.enum(["server", "client"]),
            call_id: z4.z.string().nullable(),
            status: z4.z.enum(["in_progress", "completed", "incomplete"]),
            arguments: z4.z.unknown()
          }),
          z4.z.object({
            type: z4.z.literal("tool_search_output"),
            id: z4.z.string(),
            execution: z4.z.enum(["server", "client"]),
            call_id: z4.z.string().nullable(),
            status: z4.z.enum(["in_progress", "completed", "incomplete"]),
            tools: z4.z.array(z4.z.record(z4.z.string(), jsonValueSchema2.optional()))
          })
        ])
      }),
      z4.z.object({
        ...
        item: z4.z.discriminatedUnion("type", [
          ...
          z4.z.object({
            ...
            action: z4.z.discriminatedUnion("type", [
              ...
              z4.z.object({
                type: z4.z.literal("find_in_page"),
                url: z4.z.string().nullish(),
                pattern: z4.z.string().nullish()
              })
            ]).nullish()
          ...
          z4.z.object({
            ...
            arguments: z4.z.string(),
            name: z4.z.string(),
            server_label: z4.z.string(),
            output: z4.z.string().nullish(),
            error: z4.z.union([
              z4.z.string(),
              z4.z.object({
                type: z4.z.string().optional(),
          ...
          z4.z.object({
            ...
            tools: z4.z.array(
              z4.z.object({
                name: z4.z.string(),
                description: z4.z.string().optional(),
                input_schema: z4.z.any(),
                annotations: z4.z.record(z4.z.string(), z4.z.unknown()).optional()
              })
            ),
            error: z4.z.union([
              z4.z.string(),
          ...
          z4.z.object({
            ...
            name: z4.z.string(),
            arguments: z4.z.string(),
            approval_request_id: z4.z.string().optional()
          }),
          z4.z.object({
            type: z4.z.literal("apply_patch_call"),
            id: z4.z.string(),
      ...
      z4.z.object({
        type: z4.z.literal("response.custom_tool_call_input.delta"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        delta: z4.z.string()
      }),
      ...
      z4.z.object({
        type: z4.z.literal("response.apply_patch_call_operation_diff.delta"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        delta: z4.z.string(),
        obfuscation: z4.z.string().nullish()
      }),
      z4.z.object({
        type: z4.z.literal("response.apply_patch_call_operation_diff.done"),
        item_id: z4.z.string(),
        output_index: z4.z.number(),
        diff: z4.z.string()
      }),
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       */
      allowedTools: z4.z.object({
        toolNames: z4.z.array(z4.z.string()).min(1),
        mode: z4.z.enum(["auto", "required"]).optional()
      }).optional()
    })
  )
);
async function prepareResponsesTools({
  ...
  for (const tool3 of tools) {
    switch (tool3.type) {
      case "function": {
        const openaiOptions = (_a18 = tool3.providerOptions) == null ? void 0 : _a18.openai;
  ...
  if (allowedTools != null) {
    return {
      ...
      toolChoice: {
        type: "allowed_tools",
        mode: (_b18 = allowedTools.mode) != null ? _b18 : "auto",
        tools: allowedTools.toolNames.map((name17) => {
          var _a23;
          return {
            type: "function",
            name: (_a23 = toolNameMapping == null ? void 0 : toolNameMapping.toProviderToolName(name17)) != null ? _a23 : name17
          };
        })
      },
      toolWarnings
...
function extractApprovalRequestIdToToolCallIdMapping(prompt) {
  ...
  for (const message of prompt) {
    ...
    for (const part of message.content) {
      ...
      const approvalRequestId = (_b18 = (_a18 = part.providerOptions) == null ? void 0 : _a18.openai) == null ? void 0 : _b18.approvalRequestId;
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const isReasoningModel = (_a18 = openaiOptions == null ? void 0 : openaiOptions.forceReasoning) != null ? _a18 : modelCapabilities.isReasoningModel;
    ...
    const {
      ...
      tools,
      toolChoice,
      allowedTools: (_b18 = openaiOptions == null ? void 0 : openaiOptions.allowedTools) != null ? _b18 : void 0,
      toolNameMapping,
      customProviderToolNames
    });
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              if (value.item.type === "function_call") {
                ...
                ongoingToolCalls[value.output_index] = {
                  toolName,
                  toolCallId,
                  toolSearchExecution: (_a18 = value.item.execution) != null ? _a18 : "server"
                };
                if (isHosted) {
                  controller.enqueue({
                    type: "tool-input-start",
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const fileExtension = mediaTypeToExtension2(mediaType);
    formData.append(
      "file",
...
function createOpenAI(options = {}) {
  var _a18, _b18;
  const baseURL = (_a18 = withoutTrailingSlash2(
...
var MASTRA_GATEWAY_STREAM_TRANSPORT = /* @__PURE__ */ Symbol.for("@mastra/core.gatewayStreamTransport");
...
var MASTRA_USER_AGENT = `mastra/${"1.43.0"}` ;
...
var GATEWAY_AUTH_HEADER = "X-Memory-Gateway-Authorization";
var VERSION5 = "3.0.82" ;
...
var anthropicStopDetailsSchema = z4.z.object({
  type: z4.z.string(),
  category: z4.z.string().nullish(),
  explanation: z4.z.string().nullish(),
  recommended_model: z4.z.string().nullish()
});
  ...
  () => zodSchema2(
    z4.z.object({
      ...
      content: z4.z.array(
        z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("text"),
            text: z4.z.string(),
            citations: z4.z.array(
              z4.z.discriminatedUnion("type", [
                z4.z.object({
                  type: z4.z.literal("web_search_result_location"),
                  cited_text: z4.z.string(),
                  url: z4.z.string(),
                  title: z4.z.string(),
                  encrypted_index: z4.z.string()
                }),
                z4.z.object({
                  type: z4.z.literal("page_location"),
                  cited_text: z4.z.string(),
                  document_index: z4.z.number(),
                  document_title: z4.z.string().nullable(),
                  start_page_number: z4.z.number(),
                  end_page_number: z4.z.number()
                }),
                z4.z.object({
                  type: z4.z.literal("char_location"),
                  cited_text: z4.z.string(),
                  document_index: z4.z.number(),
                  document_title: z4.z.string().nullable(),
                  start_char_index: z4.z.number(),
                  end_char_index: z4.z.number()
                })
              ])
            ).optional()
          }),
          z4.z.object({
            ...
            thinking: z4.z.string(),
            signature: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("redacted_thinking"),
            data: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("compaction"),
            content: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("tool_use"),
            id: z4.z.string(),
            name: z4.z.string(),
            input: z4.z.unknown(),
            ...
            caller: z4.z.union([
              z4.z.object({
                type: z4.z.literal("code_execution_20250825"),
                tool_id: z4.z.string()
              }),
              z4.z.object({
                type: z4.z.literal("code_execution_20260120"),
                tool_id: z4.z.string()
              }),
              z4.z.object({
                type: z4.z.literal("direct")
              })
            ]).optional()
          }),
          z4.z.object({
            type: z4.z.literal("server_tool_use"),
            id: z4.z.string(),
            name: z4.z.string(),
            input: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
            caller: z4.z.union([
              z4.z.object({
                type: z4.z.literal("code_execution_20260120"),
                tool_id: z4.z.string()
          ...
          z4.z.object({
            type: z4.z.literal("mcp_tool_use"),
            id: z4.z.string(),
            name: z4.z.string(),
            input: z4.z.unknown(),
            server_name: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("mcp_tool_result"),
            tool_use_id: z4.z.string(),
            is_error: z4.z.boolean(),
            content: z4.z.array(
              z4.z.union([
                z4.z.string(),
                z4.z.object({ type: z4.z.literal("text"), text: z4.z.string() })
              ])
            )
          }),
          z4.z.object({
            type: z4.z.literal("web_fetch_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.union([
              z4.z.object({
                type: z4.z.literal("web_fetch_result"),
                url: z4.z.string(),
                retrieved_at: z4.z.string(),
                content: z4.z.object({
                  type: z4.z.literal("document"),
                  title: z4.z.string().nullable(),
                  citations: z4.z.object({ enabled: z4.z.boolean() }).optional(),
                  source: z4.z.union([
                    z4.z.object({
                      type: z4.z.literal("base64"),
                      media_type: z4.z.literal("application/pdf"),
                      data: z4.z.string()
                    }),
                    z4.z.object({
                      type: z4.z.literal("text"),
                      media_type: z4.z.literal("text/plain"),
                      data: z4.z.string()
                    })
                  ])
                })
              ...
              z4.z.object({
                type: z4.z.literal("web_fetch_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
          z4.z.object({
            type: z4.z.literal("web_search_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.union([
              z4.z.array(
                z4.z.object({
                  type: z4.z.literal("web_search_result"),
                  url: z4.z.string(),
                  title: z4.z.string(),
                  encrypted_content: z4.z.string(),
                  page_age: z4.z.string().nullish()
                })
              ),
              z4.z.object({
                type: z4.z.literal("web_search_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
          ...
          z4.z.object({
            type: z4.z.literal("code_execution_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.union([
              z4.z.object({
                type: z4.z.literal("code_execution_result"),
                stdout: z4.z.string(),
                stderr: z4.z.string(),
                return_code: z4.z.number(),
                content: z4.z.array(
                  z4.z.object({
                    type: z4.z.literal("code_execution_output"),
                    file_id: z4.z.string()
                  })
                ).optional().default([])
              }),
              z4.z.object({
                type: z4.z.literal("encrypted_code_execution_result"),
                encrypted_stdout: z4.z.string(),
                stderr: z4.z.string(),
                return_code: z4.z.number(),
                content: z4.z.array(
                  z4.z.object({
              ...
              z4.z.object({
                type: z4.z.literal("code_execution_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
          ...
          z4.z.object({
            type: z4.z.literal("bash_code_execution_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.discriminatedUnion("type", [
              z4.z.object({
                type: z4.z.literal("bash_code_execution_result"),
                content: z4.z.array(
                  z4.z.object({
                    type: z4.z.literal("bash_code_execution_output"),
                    file_id: z4.z.string()
                  })
                ),
                stdout: z4.z.string(),
              ...
              z4.z.object({
                type: z4.z.literal("bash_code_execution_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
          ...
          z4.z.object({
            type: z4.z.literal("text_editor_code_execution_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.discriminatedUnion("type", [
              z4.z.object({
                type: z4.z.literal("text_editor_code_execution_tool_result_error"),
                error_code: z4.z.string()
              }),
              z4.z.object({
                type: z4.z.literal("text_editor_code_execution_view_result"),
                content: z4.z.string(),
                file_type: z4.z.string(),
                num_lines: z4.z.number().nullable(),
                start_line: z4.z.number().nullable(),
                total_lines: z4.z.number().nullable()
              }),
              z4.z.object({
                type: z4.z.literal("text_editor_code_execution_create_result"),
                is_file_update: z4.z.boolean()
              }),
              z4.z.object({
                type: z4.z.literal(
                  "text_editor_code_execution_str_replace_result"
                ),
                lines: z4.z.array(z4.z.string()).nullable(),
                new_lines: z4.z.number().nullable(),
                new_start: z4.z.number().nullable(),
                old_lines: z4.z.number().nullable(),
                old_start: z4.z.number().nullable()
              })
            ])
          }),
          // tool search tool results for tool_search_tool_regex_20251119 and tool_search_tool_bm25_20251119:
          z4.z.object({
            type: z4.z.literal("tool_search_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.union([
              z4.z.object({
                type: z4.z.literal("tool_search_tool_search_result"),
                tool_references: z4.z.array(
                  z4.z.object({
                    type: z4.z.literal("tool_reference"),
                    tool_name: z4.z.string()
                  })
                )
              }),
              z4.z.object({
                type: z4.z.literal("tool_search_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
          ...
          z4.z.object({
            type: z4.z.literal("advisor_tool_result"),
            tool_use_id: z4.z.string(),
            content: z4.z.discriminatedUnion("type", [
              z4.z.object({
                type: z4.z.literal("advisor_result"),
                text: z4.z.string()
              }),
              z4.z.object({
                type: z4.z.literal("advisor_redacted_result"),
                encrypted_content: z4.z.string()
              }),
              z4.z.object({
                type: z4.z.literal("advisor_tool_result_error"),
                error_code: z4.z.string()
              })
            ])
          }),
      ...
      usage: z4.z.looseObject({
        ...
        iterations: z4.z.array(
          z4.z.object({
            type: z4.z.union([
              z4.z.literal("compaction"),
              z4.z.literal("message"),
              z4.z.literal("advisor_message"),
              z4.z.literal("fallback_message")
            ]),
            model: z4.z.string().nullish(),
            input_tokens: z4.z.number(),
            output_tokens: z4.z.number(),
      ...
      context_management: z4.z.object({
        applied_edits: z4.z.array(
          z4.z.union([
            z4.z.object({
              type: z4.z.literal("clear_tool_uses_20250919"),
              cleared_tool_uses: z4.z.number(),
              cleared_input_tokens: z4.z.number()
            }),
            z4.z.object({
              type: z4.z.literal("clear_thinking_20251015"),
              cleared_thinking_turns: z4.z.number(),
              cleared_input_tokens: z4.z.number()
            }),
            z4.z.object({
              type: z4.z.literal("compact_20260112")
            })
          ])
        )
      }).nullish()
...
var anthropicMessagesChunkSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      z4.z.object({
        type: z4.z.literal("message_start"),
        message: z4.z.object({
          id: z4.z.string().nullish(),
          model: z4.z.string().nullish(),
          role: z4.z.string().nullish(),
          usage: z4.z.looseObject({
            input_tokens: z4.z.number(),
            cache_creation_input_tokens: z4.z.number().nullish(),
            cache_read_input_tokens: z4.z.number().nullish()
      ...
      z4.z.object({
        type: z4.z.literal("content_block_start"),
        index: z4.z.number(),
        content_block: z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("text"),
            text: z4.z.string()
          }),
          ...
          z4.z.object({
            ...
            input: z4.z.record(z4.z.string(), z4.z.unknown()).optional(),
            // Programmatic tool calling: caller info when triggered from code execution
            caller: z4.z.union([
              z4.z.object({
                type: z4.z.literal("code_execution_20250825"),
      ...
      z4.z.object({
        type: z4.z.literal("content_block_delta"),
        index: z4.z.number(),
        delta: z4.z.discriminatedUnion("type", [
          z4.z.object({
            type: z4.z.literal("input_json_delta"),
            partial_json: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("text_delta"),
            text: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("thinking_delta"),
            thinking: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("signature_delta"),
            signature: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("compaction_delta"),
            content: z4.z.string().nullish()
          }),
          z4.z.object({
            type: z4.z.literal("citations_delta"),
            citation: z4.z.discriminatedUnion("type", [
              z4.z.object({
                type: z4.z.literal("web_search_result_location"),
                cited_text: z4.z.string(),
                url: z4.z.string(),
      ...
      z4.z.object({
        type: z4.z.literal("content_block_stop"),
        index: z4.z.number()
      }),
      z4.z.object({
        type: z4.z.literal("error"),
      ...
      z4.z.object({
        type: z4.z.literal("message_stop")
      }),
      z4.z.object({
        type: z4.z.literal("ping")
      })
    ])
  )
);
var anthropicReasoningMetadataSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      signature: z4.z.string().optional(),
      redactedData: z4.z.string().optional()
    })
  )
);
var anthropicFilePartProviderOptions = z4.z.object({
  /**
   * Citation configuration for this document.
   * When enabled, this document will generate citations in the response.
   */
  citations: z4.z.object({
    /**
     * Enable citations for this document
     */
    enabled: z4.z.boolean()
  }).optional(),
  /**
   * Custom title for the document.
   * If not provided, the filename will be used.
   */
  title: z4.z.string().optional(),
  /**
   * Context about the document that will be passed to the model
   * but not used towards cited content.
   * Useful for storing document metadata as text or stringified JSON.
   */
  context: z4.z.string().optional()
});
var anthropicLanguageModelOptions = z4.z.object({
  /**
   * Whether to send reasoning to the model.
   *
   * This allows you to deactivate reasoning inputs for models that do not support them.
   */
  sendReasoning: z4.z.boolean().optional(),
  /**
   ...
   */
  structuredOutputMode: z4.z.enum(["outputFormat", "jsonTool", "auto"]).optional(),
  /**
   ...
   */
  thinking: z4.z.discriminatedUnion("type", [
    z4.z.object({
      /** for Sonnet 4.6, Opus 4.6, and newer models */
      type: z4.z.literal("adaptive"),
      /**
       * Controls whether thinking content is included in the response.
       * - `"omitted"`: Thinking blocks are present but text is empty (default for Opus 4.7+).
       * - `"summarized"`: Thinking content is returned. Required to see reasoning output.
       */
      display: z4.z.enum(["omitted", "summarized"]).optional()
    }),
    z4.z.object({
      /** for models before Opus 4.6, except Sonnet 4.6 still supports it */
      type: z4.z.literal("enabled"),
      budgetTokens: z4.z.number().optional()
    }),
    z4.z.object({
      type: z4.z.literal("disabled")
    })
  ]).optional(),
  /**
   ...
   */
  disableParallelToolUse: z4.z.boolean().optional(),
  /**
   * Cache control settings for this message.
   * See https://docs.anthropic.com/en/docs/build-with-claude/prompt-caching
   */
  cacheControl: z4.z.object({
    type: z4.z.literal("ephemeral"),
    ttl: z4.z.union([z4.z.literal("5m"), z4.z.literal("1h")]).optional()
  }).optional(),
  /**
  ...
  metadata: z4.z.object({
     ...
     */
    userId: z4.z.string().optional()
  }).optional(),
  /**
   * MCP servers to be utilized in this request.
   */
  mcpServers: z4.z.array(
    z4.z.object({
      type: z4.z.literal("url"),
      name: z4.z.string(),
      url: z4.z.string(),
      authorizationToken: z4.z.string().nullish(),
      toolConfiguration: z4.z.object({
        enabled: z4.z.boolean().nullish(),
        allowedTools: z4.z.array(z4.z.string()).nullish()
      }).nullish()
    })
  ).optional(),
  /**
   ...
   * @default true
   */
  toolStreaming: z4.z.boolean().optional(),
  /**
   * @default 'high'
   */
  effort: z4.z.enum(["low", "medium", "high", "xhigh", "max"]).optional(),
  /**
   ...
   */
  taskBudget: z4.z.object({
    type: z4.z.literal("tokens"),
    total: z4.z.number().int().min(2e4),
    remaining: z4.z.number().int().min(0).optional()
  }).optional(),
  /**
   * Enable fast mode for faster inference (2.5x faster output token speeds).
   * Only supported with claude-opus-4-6.
   */
  speed: z4.z.enum(["fast", "standard"]).optional(),
  /**
   ...
   */
  inferenceGeo: z4.z.enum(["us", "global"]).optional(),
  /**
   ...
   */
  fallbacks: z4.z.array(
    z4.z.object({
      model: z4.z.string(),
      max_tokens: z4.z.number().int().optional(),
      thinking: z4.z.record(z4.z.string(), z4.z.unknown()).optional(),
      output_config: z4.z.record(z4.z.string(), z4.z.unknown()).optional(),
      speed: z4.z.enum(["fast", "standard"]).optional()
    })
  ).optional(),
  /**
   ...
   */
  anthropicBeta: z4.z.array(z4.z.string()).optional(),
  contextManagement: z4.z.object({
    edits: z4.z.array(
      z4.z.discriminatedUnion("type", [
        z4.z.object({
          type: z4.z.literal("clear_tool_uses_20250919"),
          trigger: z4.z.discriminatedUnion("type", [
            z4.z.object({
              type: z4.z.literal("input_tokens"),
              value: z4.z.number()
            }),
            z4.z.object({
              type: z4.z.literal("tool_uses"),
              value: z4.z.number()
            })
          ]).optional(),
          keep: z4.z.object({
          ...
          clearAtLeast: z4.z.object({
            type: z4.z.literal("input_tokens"),
            value: z4.z.number()
          }).optional(),
          clearToolInputs: z4.z.boolean().optional(),
          excludeTools: z4.z.array(z4.z.string()).optional()
        }),
        z4.z.object({
          type: z4.z.literal("clear_thinking_20251015"),
          keep: z4.z.union([
            z4.z.literal("all"),
            z4.z.object({
              type: z4.z.literal("thinking_turns"),
              value: z4.z.number()
            })
          ]).optional()
        }),
        z4.z.object({
          ...
          pauseAfterCompaction: z4.z.boolean().optional(),
          instructions: z4.z.string().optional()
        })
      ])
    )
  }).optional()
...
var advisor_20260301ArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      model: z4.z.string(),
      maxUses: z4.z.number().optional(),
      caching: z4.z.object({
        type: z4.z.literal("ephemeral"),
        ttl: z4.z.union([z4.z.literal("5m"), z4.z.literal("1h")])
      }).optional()
    })
  )
);
var advisor_20260301OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      z4.z.object({
        type: z4.z.literal("advisor_result"),
      ...
      z4.z.object({
        type: z4.z.literal("advisor_redacted_result"),
        encryptedContent: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("advisor_tool_result_error"),
        errorCode: z4.z.string()
      })
    ])
  )
);
var advisor_20260301InputSchema = lazySchema2(
  () => zodSchema2(z4.z.object({}).strict())
);
...
var textEditor_20250728ArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      maxCharacters: z4.z.number().optional()
    })
  )
);
var textEditor_20250728InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      command: z4.z.enum(["view", "create", "str_replace", "insert"]),
      path: z4.z.string(),
      file_text: z4.z.string().optional(),
      insert_line: z4.z.number().int().optional(),
      new_str: z4.z.string().optional(),
      insert_text: z4.z.string().optional(),
      old_str: z4.z.string().optional(),
      view_range: z4.z.array(z4.z.number().int()).optional()
    })
  )
);
...
var webSearch_20260209ArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      maxUses: z4.z.number().optional(),
      allowedDomains: z4.z.array(z4.z.string()).optional(),
...
var webSearch_20260209OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.array(
      z4.z.object({
        url: z4.z.string(),
        title: z4.z.string().nullable(),
        pageAge: z4.z.string().nullable(),
        encryptedContent: z4.z.string(),
        type: z4.z.literal("web_search_result")
      })
    )
...
var webSearch_20260209InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      query: z4.z.string()
    })
...
var webFetch_20260209ArgsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      maxUses: z4.z.number().optional(),
      allowedDomains: z4.z.array(z4.z.string()).optional(),
      blockedDomains: z4.z.array(z4.z.string()).optional(),
      citations: z4.z.object({ enabled: z4.z.boolean() }).optional(),
      maxContentTokens: z4.z.number().optional()
    })
  )
);
var webFetch_20260209OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      type: z4.z.literal("web_fetch_result"),
      url: z4.z.string(),
      content: z4.z.object({
        ...
        source: z4.z.union([
          z4.z.object({
            type: z4.z.literal("base64"),
            mediaType: z4.z.literal("application/pdf"),
            data: z4.z.string()
          }),
          z4.z.object({
            type: z4.z.literal("text"),
            mediaType: z4.z.literal("text/plain"),
            data: z4.z.string()
          })
        ])
      }),
      retrievedAt: z4.z.string().nullable()
    })
  )
);
var webFetch_20260209InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      url: z4.z.string()
    })
  ...
  for (const tool3 of tools) {
    switch (tool3.type) {
      case "function": {
        ...
        const anthropicOptions = (_a18 = tool3.providerOptions) == null ? void 0 : _a18.anthropic;
        const eagerInputStreaming = (_b18 = anthropicOptions == null ? void 0 : anthropicOptions.eagerInputStreaming) != null ? _b18 : defaultEagerInputStreaming;
        ...
        anthropicTools2.push({
          ...
          ...tool3.inputExamples != null ? {
            input_examples: tool3.inputExamples.map(
        ...
        if (tool3.inputExamples != null || allowedCallers != null) {
        ...
        switch (tool3.id) {
          ...
          case "anthropic.computer_20251124": {
            ...
            anthropicTools2.push({
              ...
              display_height_px: tool3.args.displayHeightPx,
              display_number: tool3.args.displayNumber,
              enable_zoom: tool3.args.enableZoom,
              cache_control: void 0
            });
            break;
          }
...
function convertAnthropicMessagesUsage({
  ...
  var _a18, _b18, _c;
  const cacheCreationTokens = (_a18 = usage.cache_creation_input_tokens) != null ? _a18 : 0;
...
var codeExecution_20250825OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      ...
      z4.z.object({
        type: z4.z.literal("text_editor_code_execution_str_replace_result"),
        lines: z4.z.array(z4.z.string()).nullable(),
        new_lines: z4.z.number().nullable(),
        new_start: z4.z.number().nullable(),
        old_lines: z4.z.number().nullable(),
...
var codeExecution_20250825InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      ...
      z4.z.object({
        type: z4.z.literal("programmatic-tool-call"),
        code: z4.z.string()
      }),
      z4.z.object({
        type: z4.z.literal("bash_code_execution"),
        command: z4.z.string()
      }),
      z4.z.discriminatedUnion("command", [
        z4.z.object({
          type: z4.z.literal("text_editor_code_execution"),
          command: z4.z.literal("view"),
          path: z4.z.string()
        }),
        z4.z.object({
          type: z4.z.literal("text_editor_code_execution"),
          command: z4.z.literal("create"),
          path: z4.z.string(),
          file_text: z4.z.string().nullish()
        }),
        z4.z.object({
          type: z4.z.literal("text_editor_code_execution"),
          command: z4.z.literal("str_replace"),
          path: z4.z.string(),
          old_str: z4.z.string(),
          new_str: z4.z.string()
        })
...
var codeExecution_20260120OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      z4.z.object({
        type: z4.z.literal("code_execution_result"),
...
var codeExecution_20260120InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.discriminatedUnion("type", [
      z4.z.object({
        type: z4.z.literal("programmatic-tool-call"),
...
var toolSearchRegex_20251119OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.array(
      z4.z.object({
        type: z4.z.literal("tool_reference"),
...
var toolSearchRegex_20251119InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      /**
...
async function extractErrorValue(value) {
  if (typeof value === "string") {
    const result = await safeParseJSON2({ text: value });
...
async function convertToAnthropicMessagesPrompt({
  ...
  async function shouldEnableCitations(providerMetadata) {
    ...
    return (_b23 = (_a23 = anthropicOptions == null ? void 0 : anthropicOptions.citations) == null ? void 0 : _a23.enabled) != null ? _b23 : false;
  }
          ...
          switch (role) {
            case "user": {
              for (let j = 0; j < content.length; j++) {
                ...
                const cacheControl = (_a18 = validator2.getCacheControl(part.providerOptions, {
                  type: "user message part",
                  canCache: true
                })) != null ? _a18 : isLastPart ? validator2.getCacheControl(message.providerOptions, {
                  type: "user message",
                  canCache: true
                }) : void 0;
                switch (part.type) {
            ...
            case "tool": {
              for (let i2 = 0; i2 < content.length; i2++) {
                ...
                const cacheControl = (_f = (_e = validator2.getCacheControl(part.providerOptions, {
                  type: "tool result part",
                  canCache: true
                })) != null ? _e : validator2.getCacheControl(outputProviderOptions, {
                  type: "tool result output",
                  canCache: true
                })) != null ? _f : isLastPart ? validator2.getCacheControl(message.providerOptions, {
      ...
      case "assistant": {
        ...
        for (let j = 0; j < block.messages.length; j++) {
          ...
          for (let k = 0; k < content.length; k++) {
            ...
            const cacheControl = (_h = validator2.getCacheControl(part.providerOptions, {
              type: "assistant message part",
              canCache: true
            })) != null ? _h : isLastContentPart ? validator2.getCacheControl(message.providerOptions, {
...
var AnthropicMessagesLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a18 = config.generateId) != null ? _a18 : generateId2;
  }
  supportsUrl(url) {
  ...
  async getArgs({
    ...
    const supportsStructuredOutput = ((_a18 = this.config.supportsNativeStructuredOutput) != null ? _a18 : true) && modelSupportsStructuredOutput;
    const supportsStrictTools = ((_b18 = this.config.supportsStrictTools) != null ? _b18 : true) && modelSupportsStructuredOutput;
  ...
  transformRequestBody(args, betas) {
    var _a18, _b18, _c;
    return (_c = (_b18 = (_a18 = this.config).transformRequestBody) == null ? void 0 : _b18.call(_a18, args, betas)) != null ? _c : args;
  }
        ...
        case "web_fetch_tool_result": {
          if (part.content.type === "web_fetch_result") {
            citationDocuments.push({
              title: (_a18 = part.content.content.title) != null ? _a18 : part.content.url,
  ...
  async doStream(options) {
    ...
    const transformedStream = response.pipeThrough(
      new TransformStream({
        ...
        transform(chunk, controller) {
          var _a23, _b23, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n;
          if (options.includeRawChunks) {
            controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
          }
          if (!chunk.success) {
                    ...
                    controller.enqueue({
                      ...
                      result: part.content.map((result) => {
                        ...
                        return {
                          url: result.url,
                          title: result.title,
                          pageAge: (_a33 = result.page_age) != null ? _a33 : null,
                          encryptedContent: result.encrypted_content,
                          type: result.type
                        };
                      })
    ...
    try {
      ...
      if (((_a18 = result.value) == null ? void 0 : _a18.type) === "raw") {
...
var computer_20241022InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      ...
      coordinate: z4.z.array(z4.z.number().int()).optional(),
      text: z4.z.string().optional()
    })
  )
);
...
var computer_20250124InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      ...
      coordinate: z4.z.tuple([z4.z.number().int(), z4.z.number().int()]).optional(),
      duration: z4.z.number().optional(),
      scroll_amount: z4.z.number().optional(),
      scroll_direction: z4.z.enum(["up", "down", "left", "right"]).optional(),
      start_coordinate: z4.z.tuple([z4.z.number().int(), z4.z.number().int()]).optional(),
      text: z4.z.string().optional()
    })
  )
);
...
var computer_20251124InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      action: z4.z.enum([
        "key",
  ...
  () => zodSchema2(
    z4.z.discriminatedUnion("command", [
      z4.z.object({
        command: z4.z.literal("view"),
        path: z4.z.string(),
        view_range: z4.z.tuple([z4.z.number(), z4.z.number()]).optional()
      }),
      z4.z.object({
        command: z4.z.literal("create"),
        path: z4.z.string(),
        file_text: z4.z.string()
      }),
      z4.z.object({
        command: z4.z.literal("str_replace"),
        path: z4.z.string(),
      ...
      z4.z.object({
        command: z4.z.literal("insert"),
        path: z4.z.string(),
        insert_line: z4.z.number(),
        insert_text: z4.z.string()
      }),
      z4.z.object({
        command: z4.z.literal("delete"),
        path: z4.z.string()
      }),
      z4.z.object({
        command: z4.z.literal("rename"),
        old_path: z4.z.string(),
        new_path: z4.z.string()
      })
    ])
  )
);
...
var textEditor_20241022InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      command: z4.z.enum(["view", "create", "str_replace", "insert", "undo_edit"]),
      path: z4.z.string(),
      file_text: z4.z.string().optional(),
      insert_line: z4.z.number().int().optional(),
      new_str: z4.z.string().optional(),
...
var toolSearchBm25_20251119OutputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.array(
      z4.z.object({
        type: z4.z.literal("tool_reference"),
...
var toolSearchBm25_20251119InputSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      /**
...
var googleEmbeddingContentPartSchema = z4.z.union([
  z4.z.object({ text: z4.z.string() }),
  z4.z.object({
    inlineData: z4.z.object({
...
var googleEmbeddingModelOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
       ...
       */
      outputDimensionality: z4.z.number().optional(),
      /**
       ...
       */
      content: z4.z.array(z4.z.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
...
var googleGenerativeAITextEmbeddingResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
...
function convertGoogleGenerativeAIUsage(usage) {
  ...
  const promptTokens = (_a18 = usage.promptTokenCount) != null ? _a18 : 0;
      ...
      case "assistant": {
        ...
        contents.push({
          ...
          parts: content.map((part) => {
            var _a23, _b23, _c2, _d2;
            const providerOpts = (_d2 = (_a23 = part.providerOptions) == null ? void 0 : _a23[providerOptionsName]) != null ? _d2 : providerOptionsName !== "google" ? (_b23 = part.providerOptions) == null ? void 0 : _b23.google : (_c2 = part.providerOptions) == null ? void 0 : _c2.vertex;
  ...
  () => zodSchema2(
    z4.z.object({
      ...
      thinkingConfig: z4.z.object({
        ...
        thinkingLevel: z4.z.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      cachedContent: z4.z.string().optional(),
      /**
       ...
       */
      audioTimestamp: z4.z.boolean().optional(),
      /**
       * Optional. Defines labels used in billing reports. Available on Vertex AI only.
       *
       * https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
       */
      labels: z4.z.record(z4.z.string(), z4.z.string()).optional(),
      /**
       * Optional. If specified, the media resolution specified will be used.
       *
       * https://ai.google.dev/api/generate-content#MediaResolution
       */
      mediaResolution: z4.z.enum([
       ...
       */
      imageConfig: z4.z.object({
        aspectRatio: z4.z.enum([
          "1:1",
          "2:3",
          "3:2",
          "3:4",
        ...
        imageSize: z4.z.enum(["1K", "2K", "4K", "512"]).optional()
      }).optional(),
      /**
       ...
       */
      retrievalConfig: z4.z.object({
        latLng: z4.z.object({
          latitude: z4.z.number(),
          longitude: z4.z.number()
        }).optional()
      }).optional(),
      /**
       ...
       */
      streamFunctionCallArguments: z4.z.boolean().optional(),
      /**
       * Optional. The service tier to use for the request.
       */
      serviceTier: z4.z.enum(["standard", "flex", "priority"]).optional()
    })
  )
);
      ...
      for (const tool3 of tools) {
        if (tool3.type === "function") {
          functionDeclarations2.push({
            name: tool3.name,
            description: (_a18 = tool3.description) != null ? _a18 : "",
    ...
    switch (tool3.type) {
      case "function":
        functionDeclarations.push({
          name: tool3.name,
          description: (_b18 = tool3.description) != null ? _b18 : "",
          parameters: convertJSONSchemaToOpenAPISchema(tool3.inputSchema)
        });
...
function resolvePartialArgValue(arg) {
  var _a18, _b18;
  const value = (_b18 = (_a18 = arg.stringValue) != null ? _a18 : arg.numberValue) != null ? _b18 : arg.boolValue;
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async getArgs({
    ...
    const streamFunctionCallArguments = isStreaming && isVertexProvider ? (_a18 = googleOptions == null ? void 0 : googleOptions.streamFunctionCallArguments) != null ? _a18 : false : void 0;
    ...
    return {
      args: {
        generationConfig: {
          ...
          ((_b18 = googleOptions == null ? void 0 : googleOptions.structuredOutputs) != null ? _b18 : true) ? convertJSONSchemaToOpenAPISchema(responseFormat.schema) : void 0,
  ...
  async doGenerate(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p;
      ...
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            ...
            const candidate = (_a18 = value.candidates) == null ? void 0 : _a18[0];
            if (candidate == null) {
              return;
            }
...
var getGroundingMetadataSchema = () => z4.z.object({
  ...
  imageSearchQueries: z4.z.array(z4.z.string()).nullish(),
  retrievalQueries: z4.z.array(z4.z.string()).nullish(),
  ...
  groundingChunks: z4.z.array(
    z4.z.object({
      ...
      image: z4.z.object({
        sourceUri: z4.z.string(),
        imageUri: z4.z.string(),
        title: z4.z.string().nullish(),
        domain: z4.z.string().nullish()
      }).nullish(),
      retrievedContext: z4.z.object({
        uri: z4.z.string().nullish(),
        title: z4.z.string().nullish(),
        text: z4.z.string().nullish(),
        fileSearchStore: z4.z.string().nullish()
      }).nullish(),
      maps: z4.z.object({
        uri: z4.z.string().nullish(),
        title: z4.z.string().nullish(),
        text: z4.z.string().nullish(),
        placeId: z4.z.string().nullish()
      }).nullish()
    })
  ).nullish(),
  groundingSupports: z4.z.array(
    z4.z.object({
      segment: z4.z.object({
        startIndex: z4.z.number().nullish(),
        endIndex: z4.z.number().nullish(),
        text: z4.z.string().nullish()
      }).nullish(),
      segment_text: z4.z.string().nullish(),
      groundingChunkIndices: z4.z.array(z4.z.number()).nullish(),
      supportChunkIndices: z4.z.array(z4.z.number()).nullish(),
      confidenceScores: z4.z.array(z4.z.number()).nullish(),
      confidenceScore: z4.z.array(z4.z.number()).nullish()
    })
  ).nullish(),
  retrievalMetadata: z4.z.union([
    z4.z.object({
      webDynamicRetrievalScore: z4.z.number()
    }),
    z4.z.object({})
  ]).nullish()
});
var partialArgSchema = z4.z.object({
  jsonPath: z4.z.string(),
  stringValue: z4.z.string().nullish(),
  numberValue: z4.z.number().nullish(),
  boolValue: z4.z.boolean().nullish(),
  nullValue: z4.z.unknown().nullish(),
  willContinue: z4.z.boolean().nullish()
});
var getContentSchema = () => z4.z.object({
  parts: z4.z.array(
    z4.z.union([
      // note: order matters since text can be fully empty
      z4.z.object({
        functionCall: z4.z.object({
          name: z4.z.string().nullish(),
          args: z4.z.unknown().nullish(),
          partialArgs: z4.z.array(partialArgSchema).nullish(),
          willContinue: z4.z.boolean().nullish()
        }),
        thoughtSignature: z4.z.string().nullish()
      }),
      z4.z.object({
        inlineData: z4.z.object({
          mimeType: z4.z.string(),
        ...
        thought: z4.z.boolean().nullish(),
        thoughtSignature: z4.z.string().nullish()
      }),
      z4.z.object({
        toolCall: z4.z.object({
          toolType: z4.z.string(),
          args: z4.z.unknown().nullish(),
          id: z4.z.string()
        }),
        thoughtSignature: z4.z.string().nullish()
      ...
      z4.z.object({
        toolResponse: z4.z.object({
          toolType: z4.z.string(),
          response: z4.z.unknown().nullish(),
          id: z4.z.string()
        }),
        thoughtSignature: z4.z.string().nullish()
      }),
      z4.z.object({
        executableCode: z4.z.object({
          language: z4.z.string(),
          code: z4.z.string()
        }).nullish(),
        codeExecutionResult: z4.z.object({
          outcome: z4.z.string(),
          output: z4.z.string().nullish()
        }).nullish(),
        text: z4.z.string().nullish(),
...
var getSafetyRatingSchema = () => z4.z.object({
  category: z4.z.string().nullish(),
  probability: z4.z.string().nullish(),
  probabilityScore: z4.z.number().nullish(),
  severity: z4.z.string().nullish(),
  severityScore: z4.z.number().nullish(),
  blocked: z4.z.boolean().nullish()
});
var tokenDetailsSchema = z4.z.array(
  z4.z.object({
    modality: z4.z.string(),
    tokenCount: z4.z.number()
  })
).nullish();
var usageSchema2 = z4.z.object({
  cachedContentTokenCount: z4.z.number().nullish(),
...
var getUrlContextMetadataSchema = () => z4.z.object({
  urlMetadata: z4.z.array(
    z4.z.object({
      retrievedUrl: z4.z.string(),
      urlRetrievalStatus: z4.z.string()
    })
  ).nullish()
});
  ...
  () => zodSchema2(
    z4.z.object({
      candidates: z4.z.array(
        z4.z.object({
          content: getContentSchema().nullish().or(z4.z.object({}).strict()),
          finishReason: z4.z.string().nullish(),
          finishMessage: z4.z.string().nullish(),
          safetyRatings: z4.z.array(getSafetyRatingSchema()).nullish(),
          groundingMetadata: getGroundingMetadataSchema().nullish(),
          urlContextMetadata: getUrlContextMetadataSchema().nullish()
        })
      ),
      usageMetadata: usageSchema2.nullish(),
      promptFeedback: z4.z.object({
        blockReason: z4.z.string().nullish(),
        safetyRatings: z4.z.array(getSafetyRatingSchema()).nullish()
      }).nullish(),
      serviceTier: z4.z.string().nullish()
    })
  )
);
...
var codeExecution = createProviderToolFactoryWithOutputSchema({
  ...
  inputSchema: z4.z.object({
    language: z4.z.string().describe("The programming language of the code."),
    code: z4.z.string().describe("The code to be executed.")
  }),
  outputSchema: z4.z.object({
    outcome: z4.z.string().describe('The outcome of the execution (e.g., "OUTCOME_OK").'),
    output: z4.z.string().describe("The output from the code execution.")
  })
});
var enterpriseWebSearch = createProviderToolFactory({
  id: "google.enterprise_web_search",
  inputSchema: lazySchema2(() => zodSchema2(z4.z.object({})))
});
...
var googleSearchToolArgsBaseSchema = z4.z.object({
  searchTypes: z4.z.object({
    webSearch: z4.z.object({}).optional(),
    imageSearch: z4.z.object({}).optional()
  }).optional(),
  timeRangeFilter: z4.z.object({
    startTime: z4.z.string(),
    endTime: z4.z.string()
  }).optional()
}).passthrough();
var googleSearchToolArgsSchema = lazySchema2(
  () => zodSchema2(googleSearchToolArgsBaseSchema)
);
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerateGemini(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i;
    const {
      prompt,
      n,
      size,
    ...
    const languageModel = new GoogleGenerativeAILanguageModel(this.modelId, {
      ...
      headers: (_a18 = this.config.headers) != null ? _a18 : {},
      fetch: this.config.fetch,
      generateId: (_b18 = this.config.generateId) != null ? _b18 : generateId2
    });
...
var googleImageResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
...
var googleImageModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
...
var GoogleGenerativeAIVideoModel = class {
  ...
  async doGenerate(options) {
    ...
    const { value: operation } = await postJsonToApi2({
...
var googleOperationSchema = z4.z.object({
  name: z4.z.string().nullish(),
  done: z4.z.boolean().nullish(),
  error: z4.z.object({
    code: z4.z.number().nullish(),
    message: z4.z.string(),
    status: z4.z.string().nullish()
  }).nullish(),
  response: z4.z.object({
    generateVideoResponse: z4.z.object({
      generatedSamples: z4.z.array(
        z4.z.object({
          video: z4.z.object({
            uri: z4.z.string().nullish()
          }).nullish()
...
var googleVideoModelOptionsSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      pollIntervalMs: z4.z.number().positive().nullish(),
      pollTimeoutMs: z4.z.number().positive().nullish(),
      personGeneration: z4.z.enum(["dont_allow", "allow_adult", "allow_all"]).nullish(),
      negativePrompt: z4.z.string().nullish(),
      referenceImages: z4.z.array(
        z4.z.object({
          bytesBase64Encoded: z4.z.string().nullish(),
          gcsUri: z4.z.string().nullish()
        })
      ).nullish()
    }).passthrough()
  )
...
function convertGoogleInteractionsUsage(usage) {
  ...
  const totalInput = (_a18 = usage.total_input_tokens) != null ? _a18 : 0;
...
function annotationToSource({
  ...
  switch (annotation.type) {
    ...
    case "file_citation": {
      const a = annotation;
      const uri = (_b18 = (_a18 = a.document_uri) != null ? _a18 : a.source) != null ? _b18 : a.file_name;
...
function builtinToolResultToSources({
  ...
  switch (block.type) {
    case "url_context_result": {
      const result = (_a18 = block.result) != null ? _a18 : [];
...
function annotationsToSources({
  ...
  for (const annotation of annotations) {
    ...
    const key = source.sourceType === "url" ? `url:${source.url}` : `doc:${(_a18 = source.filename) != null ? _a18 : source.title}`;
...
function buildGoogleInteractionsStreamTransform({
  ...
  function sourceKey(source) {
    var _a18;
    return source.sourceType === "url" ? `url:${source.url}` : `doc:${(_a18 = source.filename) != null ? _a18 : source.title}`;
  }
      ...
      switch (eventType) {
        ...
        case "content.start": {
          ...
          if ((block == null ? void 0 : block.type) === "text") {
            ...
            const fc = block;
            const toolCallId = (_a18 = fc.id) != null ? _a18 : blockId;
            hasFunctionCall = true;
            const state = {
              kind: "function_call",
              id: blockId,
              toolCallId,
              toolName: fc.name,
              arguments: (_b18 = fc.arguments) != null ? _b18 : {},
      ...
      case "assistant": {
        ...
        for (const part of message.content) {
          if (part.type === "text") {
            ...
            const signature = (_b18 = (_a18 = part.providerOptions) == null ? void 0 : _a18.google) == null ? void 0 : _b18.signature;
            content.push({
              type: "thought",
              ...signature != null ? { signature } : {},
  ...
  for (const message of prompt) {
    if (message.role === "assistant") {
      const matchesLinkedInteraction = message.content.some((part) => {
        var _a18, _b18;
        const partInteractionId = (_b18 = (_a18 = part.providerOptions) == null ? void 0 : _a18.google) == null ? void 0 : _b18.interactionId;
  ...
  switch (output.type) {
    ...
    case "execution-denied":
      return {
        ...base,
        is_error: true,
        result: (_a18 = output.reason) != null ? _a18 : "Tool execution denied by user."
      };
    case "content": {
      const blocks = [];
...
var tokenByModalitySchema = () => z4.z.object({
  modality: z4.z.string().nullish(),
  tokens: z4.z.number().nullish()
}).loose();
var usageSchema22 = () => z4.z.object({
  total_input_tokens: z4.z.number().nullish(),
  total_output_tokens: z4.z.number().nullish(),
  total_thought_tokens: z4.z.number().nullish(),
  total_cached_tokens: z4.z.number().nullish(),
  total_tool_use_tokens: z4.z.number().nullish(),
  total_tokens: z4.z.number().nullish(),
  input_tokens_by_modality: z4.z.array(tokenByModalitySchema()).nullish(),
  output_tokens_by_modality: z4.z.array(tokenByModalitySchema()).nullish(),
  cached_tokens_by_modality: z4.z.array(tokenByModalitySchema()).nullish(),
  tool_use_tokens_by_modality: z4.z.array(tokenByModalitySchema()).nullish(),
  grounding_tool_count: z4.z.array(
    z4.z.object({
      type: z4.z.string().nullish(),
      count: z4.z.number().nullish()
    }).loose()
  ).nullish()
}).loose();
var interactionStatusSchema = () => z4.z.enum([
  "in_progress",
  "requires_action",
  "completed",
  "failed",
...
var annotationSchema = () => {
  ...
  const fileCitation = z4.z.object({
    type: z4.z.literal("file_citation"),
    file_name: z4.z.string().nullish(),
    document_uri: z4.z.string().nullish(),
    source: z4.z.string().nullish(),
    page_number: z4.z.number().nullish(),
    media_id: z4.z.string().nullish(),
    start_index: z4.z.number().nullish(),
    end_index: z4.z.number().nullish(),
    custom_metadata: z4.z.record(z4.z.string(), z4.z.unknown()).nullish()
  }).loose();
  const placeCitation = z4.z.object({
    type: z4.z.literal("place_citation"),
    name: z4.z.string().nullish(),
    url: z4.z.string().nullish(),
    place_id: z4.z.string().nullish(),
    start_index: z4.z.number().nullish(),
    end_index: z4.z.number().nullish()
  }).loose();
  return z4.z.union([
    ...
    fileCitation,
    placeCitation,
    z4.z.object({ type: z4.z.string() }).loose()
  ]);
};
var thoughtSummaryItemSchema = () => z4.z.object({
  type: z4.z.string(),
  text: z4.z.string().nullish(),
  data: z4.z.string().nullish(),
  mime_type: z4.z.string().nullish()
}).loose();
var contentBlockSchema = () => {
  const textContent = z4.z.object({
    type: z4.z.literal("text"),
    text: z4.z.string(),
    annotations: z4.z.array(annotationSchema()).nullish()
  }).loose();
  const thoughtContent = z4.z.object({
    type: z4.z.literal("thought"),
    signature: z4.z.string().nullish(),
    summary: z4.z.array(thoughtSummaryItemSchema()).nullish()
  }).loose();
  const functionCallContent = z4.z.object({
    type: z4.z.literal("function_call"),
    id: z4.z.string(),
    name: z4.z.string(),
    arguments: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
    signature: z4.z.string().nullish()
  }).loose();
  const imageContent = z4.z.object({
    type: z4.z.literal("image"),
    data: z4.z.string().nullish(),
    mime_type: z4.z.string().nullish(),
    resolution: z4.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
    uri: z4.z.string().nullish()
  }).loose();
  const builtinToolCall = z4.z.object({
    type: z4.z.enum([
      "google_search_call",
      "code_execution_call",
      "url_context_call",
    ...
    arguments: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
    name: z4.z.string().nullish(),
    server_name: z4.z.string().nullish(),
    search_type: z4.z.string().nullish(),
    signature: z4.z.string().nullish()
  }).loose();
  const builtinToolResult = z4.z.object({
    type: z4.z.enum([
      "google_search_result",
      "code_execution_result",
      "url_context_result",
    ...
    call_id: z4.z.string(),
    result: z4.z.unknown().nullish(),
    is_error: z4.z.boolean().nullish(),
    name: z4.z.string().nullish(),
    server_name: z4.z.string().nullish(),
    signature: z4.z.string().nullish()
  }).loose();
...
var googleInteractionsResponseSchema = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      /*
       ...
       */
      id: z4.z.string().nullish(),
      created: z4.z.string().nullish(),
      updated: z4.z.string().nullish(),
      status: interactionStatusSchema(),
      model: z4.z.string().nullish(),
      agent: z4.z.string().nullish(),
      outputs: z4.z.array(contentBlockSchema()).nullish(),
      usage: usageSchema22().nullish(),
      service_tier: z4.z.string().nullish(),
      previous_interaction_id: z4.z.string().nullish(),
      response_modalities: z4.z.array(z4.z.string()).nullish()
    }).loose()
  )
);
var googleInteractionsEventSchema = lazySchema2(
  () => zodSchema2(
    (() => {
      const status = interactionStatusSchema();
      const annotation = annotationSchema();
      const thoughtSummaryItem = thoughtSummaryItemSchema();
      const interactionStartEvent = z4.z.object({
        event_type: z4.z.literal("interaction.start"),
        event_id: z4.z.string().nullish(),
        interaction: z4.z.object({
          /*
      ...
      const contentStartEvent = z4.z.object({
        event_type: z4.z.literal("content.start"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number(),
        content: contentBlockSchema()
      }).loose();
      const contentDeltaText = z4.z.object({
        type: z4.z.literal("text"),
        text: z4.z.string()
      }).loose();
      const contentDeltaThoughtSummary = z4.z.object({
        type: z4.z.literal("thought_summary"),
        content: thoughtSummaryItem.nullish()
      }).loose();
      const contentDeltaThoughtSignature = z4.z.object({
        type: z4.z.literal("thought_signature"),
        signature: z4.z.string().nullish()
      }).loose();
      const contentDeltaFunctionCall = z4.z.object({
        type: z4.z.literal("function_call"),
        id: z4.z.string(),
        name: z4.z.string(),
        arguments: z4.z.record(z4.z.string(), z4.z.unknown()).nullish(),
      ...
      const contentDeltaTextAnnotation = z4.z.object({
        type: z4.z.literal("text_annotation"),
        annotations: z4.z.array(annotation).nullish()
      }).loose();
      const contentDeltaImage = z4.z.object({
        type: z4.z.literal("image"),
        data: z4.z.string().nullish(),
        mime_type: z4.z.string().nullish(),
        resolution: z4.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      ...
      const contentDeltaBuiltinToolCall = z4.z.object({
        type: z4.z.enum([
          "google_search_call",
          "code_execution_call",
          "url_context_call",
      ...
      const contentDeltaBuiltinToolResult = z4.z.object({
        type: z4.z.enum([
          "google_search_result",
          "code_execution_result",
          "url_context_result",
      ...
      const contentDeltaUnknown = z4.z.object({ type: z4.z.string() }).loose();
      const contentDeltaUnion = z4.z.union([
        contentDeltaText,
        contentDeltaImage,
      ...
      const contentDeltaEvent = z4.z.object({
        event_type: z4.z.literal("content.delta"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number(),
        delta: contentDeltaUnion
      }).loose();
      const contentStopEvent = z4.z.object({
        event_type: z4.z.literal("content.stop"),
        event_id: z4.z.string().nullish(),
        index: z4.z.number()
      }).loose();
      const interactionStatusUpdateEvent = z4.z.object({
        event_type: z4.z.literal("interaction.status_update"),
        event_id: z4.z.string().nullish(),
        interaction_id: z4.z.string().nullish(),
        status
      }).loose();
      const interactionCompleteEvent = z4.z.object({
        event_type: z4.z.literal("interaction.complete"),
        event_id: z4.z.string().nullish(),
        interaction: z4.z.object({
          id: z4.z.string().nullish(),
          status: status.nullish(),
      ...
      const errorEvent = z4.z.object({
        event_type: z4.z.literal("error"),
        event_id: z4.z.string().nullish(),
        error: z4.z.object({
          code: z4.z.string().nullish(),
      ...
      const unknownEvent = z4.z.object({ event_type: z4.z.string() }).loose();
      return z4.z.union([
...
var googleInteractionsLanguageModelOptions = lazySchema2(
  () => zodSchema2(
    z4.z.object({
      previousInteractionId: z4.z.string().nullish(),
      store: z4.z.boolean().nullish(),
      agent: z4.z.string().nullish(),
      agentConfig: z4.z.union([
        z4.z.object({
          type: z4.z.literal("dynamic")
        }).loose(),
        z4.z.object({
          type: z4.z.literal("deep-research"),
          thinkingSummaries: z4.z.enum(["auto", "none"]).nullish(),
          visualization: z4.z.enum(["off", "auto"]).nullish(),
          collaborativePlanning: z4.z.boolean().nullish()
        })
      ]).nullish(),
      thinkingLevel: z4.z.enum(["minimal", "low", "medium", "high"]).nullish(),
      thinkingSummaries: z4.z.enum(["auto", "none"]).nullish(),
      imageConfig: z4.z.object({
        aspectRatio: z4.z.enum([
          "1:1",
        ...
        imageSize: z4.z.enum(["1K", "2K", "4K", "512"]).nullish()
      }).nullish(),
      mediaResolution: z4.z.enum(["low", "medium", "high", "ultra_high"]).nullish(),
      responseModalities: z4.z.array(z4.z.enum(["text", "image", "audio", "video", "document"])).nullish(),
      serviceTier: z4.z.enum(["flex", "standard", "priority"]).nullish(),
      /**
       * Alternative to AI SDK `system` message. If both are set, the AI SDK
       * `system` message wins and a warning is emitted.
       */
      systemInstruction: z4.z.string().nullish(),
      /**
       ...
       * `previousInteractionId`.
       */
      interactionId: z4.z.string().nullish(),
      /**
       ...
       */
      pollingTimeoutMs: z4.z.number().int().positive().nullish()
    })
  )
);
...
function parseGoogleInteractionsOutputs({
  ...
  for (const block of outputs) {
    ...
    switch (type) {
      case "text": {
        const text = (_a18 = block.text) != null ? _a18 : "";
      ...
      case "image": {
        ...
        if (image.data != null && image.data.length > 0) {
          content.push({
            type: "file",
            mediaType: (_b18 = image.mime_type) != null ? _b18 : "image/png",
            data: image.data,
            ...googleProviderMetadata({ interactionId })
          });
...
function prepareGoogleInteractionsTools({
  ...
  for (const tool3 of normalized) {
    ...
    if (tool3.type === "provider") {
      const args = (_b18 = tool3.args) != null ? _b18 : {};
      switch (tool3.id) {
        case "google.google_search": {
  ...
  return new ReadableStream({
    start(controller) {
      ...
      controller.enqueue({
        type: "response-metadata",
        ...interactionId != null ? { id: interactionId } : {},
        modelId: (_a18 = response.model) != null ? _a18 : void 0,
        ...timestamp ? { timestamp } : {}
      });
      if (includeRawChunks) {
      ...
      const { content, hasFunctionCall } = parseGoogleInteractionsOutputs({
        outputs: (_b18 = response.outputs) != null ? _b18 : null,
        generateId: generateId3,
        interactionId
      });
      let blockCounter = 0;
...
var GoogleInteractionsLanguageModel = class {
  ...
  async getArgs(options) {
    var _a18, _b18, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t;
    const warnings = [];
    ...
    let responseFormat;
    if (((_a18 = options.responseFormat) == null ? void 0 : _a18.type) === "json") {
      if (isAgent) {
        warnings.push({
          type: "other",
    ...
    const {
      ...
      previousInteractionId: (_b18 = opts == null ? void 0 : opts.previousInteractionId) != null ? _b18 : void 0,
  ...
  async doGenerate(options) {
    ...
    if (isAgent && !isTerminalStatus(response.status)) {
      ...
      responseHeaders = (_a18 = polled.responseHeaders) != null ? _a18 : responseHeaders;
    }
    const interactionId = typeof response.id === "string" && response.id.length > 0 ? response.id : void 0;
    const { content, hasFunctionCall } = parseGoogleInteractionsOutputs({
      outputs: (_b18 = response.outputs) != null ? _b18 : null,
      generateId: (_c = this.config.generateId) != null ? _c : generateId2,
      interactionId
    });
    const finishReason = {
      unified: mapGoogleInteractionsFinishReason({
  ...
  async doStream(options) {
    ...
    const transform = buildGoogleInteractionsStreamTransform({
      warnings,
      generateId: (_a18 = this.config.generateId) != null ? _a18 : generateId2,
  ...
  async doStreamAgent({
    ...
    if (!isTerminalStatus(postResponse.status)) {
      ...
      postHeaders = (_a18 = polled.responseHeaders) != null ? _a18 : postHeaders;
    }
...
exports.AISDKError = AISDKError2;
exports.APICallError = APICallError;
exports.APICallError2 = APICallError2;
exports.EXCLUDED_PROVIDERS = EXCLUDED_PROVIDERS;
exports.GATEWAY_AUTH_HEADER = GATEWAY_AUTH_HEADER;
exports.InvalidPromptError = InvalidPromptError;
exports.InvalidResponseDataError = InvalidResponseDataError;
exports.InvalidResponseDataError2 = InvalidResponseDataError2;
exports.MASTRA_GATEWAY_STREAM_TRANSPORT = MASTRA_GATEWAY_STREAM_TRANSPORT;
exports.MASTRA_USER_AGENT = MASTRA_USER_AGENT;
exports.MastraModelGateway = MastraModelGateway;
exports.NoSuchModelError = NoSuchModelError;
exports.NoSuchModelError2 = NoSuchModelError2;
...
exports.PROVIDERS_WITH_INSTALLED_PACKAGES = PROVIDERS_WITH_INSTALLED_PACKAGES;
exports.TooManyEmbeddingValuesForCallError = TooManyEmbeddingValuesForCallError;
exports.TooManyEmbeddingValuesForCallError2 = TooManyEmbeddingValuesForCallError2;
exports.UnsupportedFunctionalityError = UnsupportedFunctionalityError;
exports.UnsupportedFunctionalityError2 = UnsupportedFunctionalityError2;
exports.combineHeaders = combineHeaders;
exports.combineHeaders2 = combineHeaders2;
exports.convertBase64ToUint8Array = convertBase64ToUint8Array;
exports.convertBase64ToUint8Array2 = convertBase64ToUint8Array2;
exports.convertImageModelFileToDataUri = convertImageModelFileToDataUri;
exports.convertToBase64 = convertToBase64;
exports.convertToBase642 = convertToBase642;
exports.convertUint8ArrayToBase64 = convertUint8ArrayToBase64;
exports.convertUint8ArrayToBase642 = convertUint8ArrayToBase642;
exports.createAnthropic = createAnthropic;
exports.createBinaryResponseHandler = createBinaryResponseHandler;
exports.createBinaryResponseHandler2 = createBinaryResponseHandler2;
exports.createEventSourceResponseHandler = createEventSourceResponseHandler;
exports.createEventSourceResponseHandler2 = createEventSourceResponseHandler2;
...
exports.createJsonErrorResponseHandler2 = createJsonErrorResponseHandler2;
...
exports.createProviderToolFactory = createProviderToolFactory;
exports.createProviderToolFactoryWithOutputSchema = createProviderToolFactoryWithOutputSchema;
exports.createStatusCodeErrorResponseHandler = createStatusCodeErrorResponseHandler2;
exports.delay = delay2;
exports.dist_exports = dist_exports;
exports.extractResponseHeaders = extractResponseHeaders2;
exports.generateId = generateId;
exports.generateId2 = generateId2;
exports.getFromApi = getFromApi2;
exports.injectJsonInstructionIntoMessages = injectJsonInstructionIntoMessages2;
exports.isParsableJson = isParsableJson;
exports.isParsableJson2 = isParsableJson2;
exports.lazySchema = lazySchema;
exports.lazySchema2 = lazySchema2;
exports.lazyValidator = lazyValidator;
exports.loadApiKey = loadApiKey;
exports.loadApiKey2 = loadApiKey2;
exports.loadOptionalSetting = loadOptionalSetting;
exports.loadSetting = loadSetting;
exports.mediaTypeToExtension = mediaTypeToExtension;
exports.mediaTypeToExtension2 = mediaTypeToExtension2;
exports.parseProviderOptions = parseProviderOptions;
exports.parseProviderOptions2 = parseProviderOptions2;
exports.postFormDataToApi = postFormDataToApi;
exports.postFormDataToApi2 = postFormDataToApi2;
exports.postJsonToApi = postJsonToApi;
exports.postJsonToApi2 = postJsonToApi2;
exports.resolve = resolve;
exports.resolve2 = resolve2;
exports.safeParseJSON = safeParseJSON2;
exports.validateTypes = validateTypes;
exports.validateTypes2 = validateTypes2;
exports.withUserAgentSuffix = withUserAgentSuffix;
exports.withUserAgentSuffix2 = withUserAgentSuffix2;
exports.withoutTrailingSlash = withoutTrailingSlash;
exports.withoutTrailingSlash2 = withoutTrailingSlash2;
exports.zodSchema = zodSchema;
exports.zodSchema2 = zodSchema2;
//# sourceMappingURL=chunk-ZFOCQ6NW.cjs.map
//# sourceMappingURL=chunk-ZFOCQ6NW.cjs.map