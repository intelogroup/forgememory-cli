import { parseMemoryRequestContext, getStateSignalsMetadata, resolveStateSignalHistory, applyStateSignal } from './chunk-OZHPE46K.js';
import { attachModelStreamTransport, readModelStreamTransport, resolveModelConfig } from './chunk-EAE64RJ5.js';
import { isStandardSchemaWithJSON, standardSchemaToJSONSchema, toStandardSchema } from './chunk-6SRTDZ7S.js';
import { resolveObservabilityContext, createObservabilityContext } from './chunk-IX6V357L.js';
import { getRootExportSpan, EntityType } from './chunk-DEQCJWZZ.js';
import { MastraBase } from './chunk-77VL4DNS.js';
import { coreContentToString, createSignal, MessageList, messagesAreEqual } from './chunk-RIEQKS4L.js';
import { parsePartialJson, isDeepEqualData } from './chunk-5PQHOJGK.js';
import { getErrorFromUnknown, MastraError, ErrorCategory, ErrorDomain } from './chunk-M7RBQNFP.js';
import { randomUUID } from 'crypto';
import { TransformStream, ReadableStream as ReadableStream$1 } from 'stream/web';
import { EventEmitter } from 'events';
import { applyCompatLayer, AnthropicSchemaCompatLayer, isZodType } from '@mastra/schema-compat';
...
function getTransformedSchema(schema, options) {
  ...
  const jsonSchema = options?.model ? applyCompatLayer({
    schema,
...
function createOutputHandler({ schema }) {
  const normalizedSchema = schema ? toStandardSchema(schema) : void 0;
      ...
      try {
        ...
        const processMethodArgs = {
          ...
          sendStateSignal: async (stateSignal) => {
            ...
            const result2 = await applyStateSignal({
              input: stateSignal,
              memory: resolvedMemory,
              thread,
              resourceId: resolvedResourceId,
...
export { DelayedPromise, MastraModelInput, MastraModelOutput, ProcessorRunner, ProcessorState, REPROCESS_PART_KEY, TripWire, createDestructurableOutput, createProcessorSendSignal, escapeUnescapedControlCharsInJsonStrings, getModelOutputForTripwire, getResponseFormat, isProcessorWorkflow, isSupportedLanguageModel, resolveThreadIdFromArgs, safeClose, safeEnqueue, summarizeActiveToolsForSpan, summarizeProcessorModelForSpan, summarizeProcessorResultForSpan, summarizeProcessorToolsForSpan, summarizeToolChoiceForSpan, supportedLanguageModelSpecifications, tryGenerateWithJsonFallback, tryStreamWithJsonFallback };
//# sourceMappingURL=chunk-X4ZG5TF4.js.map
//# sourceMappingURL=chunk-X4ZG5TF4.js.map