...
function coerceStringifiedJsonValues(schema, input) {
  ...
  const unwrapped = chunkCMKSC37Z_cjs.unwrapZodType(schema);
  if (!chunkCMKSC37Z_cjs.isZodObject(unwrapped)) {
    return input;
  }
  ...
  for (const [key, value] of Object.entries(input)) {
    ...
    const baseFieldSchema = chunkCMKSC37Z_cjs.unwrapZodType(fieldSchema);
    if (chunkCMKSC37Z_cjs.getZodTypeName(baseFieldSchema) === "ZodString") {
      continue;
    }
    const trimmed = value.trim();
    if (chunkCMKSC37Z_cjs.isZodArray(baseFieldSchema) && trimmed.startsWith("[") || chunkCMKSC37Z_cjs.isZodObject(baseFieldSchema) && trimmed.startsWith("{")) {
      try {
        const parsed = JSON.parse(value);
        if (chunkCMKSC37Z_cjs.isZodArray(baseFieldSchema) && Array.isArray(parsed) || chunkCMKSC37Z_cjs.isZodObject(baseFieldSchema) && isPlainObject(parsed)) {
          result[key] = parsed;
          changed = true;
        }
      } catch {
        ...
        if (!context) {
          ...
          if (isAgentExecution && !baseContext.agent) {
            ...
            organizedContext = {
              ...
              requestContext: rest.requestContext || new chunkPJIAL3WK_cjs.RequestContext()
            };
            ...
            organizedContext = {
              ...
              requestContext: baseContext.requestContext || new chunkPJIAL3WK_cjs.RequestContext()
            };
          }
        }
...
exports.getNeedsApprovalFn = getNeedsApprovalFn;
...
//# sourceMappingURL=chunk-Y4FZMBP5.cjs.map
//# sourceMappingURL=chunk-Y4FZMBP5.cjs.map