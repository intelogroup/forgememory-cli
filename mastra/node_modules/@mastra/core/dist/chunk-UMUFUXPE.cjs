...
var ScorerDefinitionsStorage = class extends chunk7Q5UQ5ES_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      scorers = scorers.filter((scorer) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunk3KZ2OT53_cjs.deepEqual(scorer.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-UMUFUXPE.cjs.map
//# sourceMappingURL=chunk-UMUFUXPE.cjs.map