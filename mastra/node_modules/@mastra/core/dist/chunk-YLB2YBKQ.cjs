...
var chunkRWB3UEF4_cjs = require('./chunk-RWB3UEF4.cjs');
var chunkDK36PFIR_cjs = require('./chunk-DK36PFIR.cjs');
var chunk6W5DBWIM_cjs = require('./chunk-6W5DBWIM.cjs');
var chunkZFOCQ6NW_cjs = require('./chunk-ZFOCQ6NW.cjs');
var chunkKS4CALMW_cjs = require('./chunk-KS4CALMW.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkKS4CALMW_cjs.createStreamFromGenerateResult(result)
    };
  }
...
function getStaticProvidersByGateway(name) {
  return Object.fromEntries(Object.entries(chunkRWB3UEF4_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name));
}
var defaultGateways = [
  new chunk6W5DBWIM_cjs.NetlifyGateway(),
  new chunkRWB3UEF4_cjs.MastraGateway(),
  new chunkDK36PFIR_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))
];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const allGateways = customGateways?.length ? [
      ...customGateways,
      ...defaultGateways.filter((dg) => !customGateways.some((cg) => chunkRWB3UEF4_cjs.getGatewayId(cg) === chunkRWB3UEF4_cjs.getGatewayId(dg)))
    ] : defaultGateways;
    this.gateway = chunkRWB3UEF4_cjs.findGatewayForModel(normalizedConfig.id, allGateways);
    this.gatewayId = chunkRWB3UEF4_cjs.getGatewayId(this.gateway);
    const gatewayPrefix = this.gatewayId === "models.dev" ? void 0 : this.gatewayId;
    const parsed = chunkDK36PFIR_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    let apiKey;
    try {
      const parsed = chunkDK36PFIR_cjs.parseModelRouterId(
        this.config.routerId,
        this.gatewayId === "models.dev" ? void 0 : this.gatewayId
      );
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunkDK36PFIR_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkKS4CALMW_cjs.AISDKV5LanguageModel(model);
  ...
  async doStream(options) {
    ...
    const gatewayPrefix = this.gatewayId === "models.dev" ? void 0 : this.gatewayId;
    const parsedModelId = chunkDK36PFIR_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix);
    ...
    if (isLanguageModelV3(model)) {
      const aiSDKV6Model = new AISDKV6LanguageModel(model);
      const streamResult2 = await aiSDKV6Model.doStream(options);
  ...
  async resolveLanguageModel({
    ...
    if (this.config.url) {
      const modelInstance2 = chunkZFOCQ6NW_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const wsFetch = chunkRWB3UEF4_cjs.createOpenAIWebSocketFetch({
      url: responsesWebSocket?.url,
      headers: responsesWebSocket?.headers
    });
    const modelInstance = chunkZFOCQ6NW_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
function readGatewayStreamTransport(model) {
  return model[chunkZFOCQ6NW_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT];
}
...
async function resolveModelConfig(modelConfig, requestContext = new chunkPJIAL3WK_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof chunkKS4CALMW_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkKS4CALMW_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var VERSION = "2.0.72" ;
var googleErrorDataSchema = chunkZFOCQ6NW_cjs.lazySchema(
...
var googleFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler({
  errorSchema: googleErrorDataSchema,
  errorToMessage: (data) => data.error.message
});
var googleEmbeddingContentPartSchema = v4.z.union([
  v4.z.object({ text: v4.z.string() }),
  v4.z.object({
...
var googleGenerativeAIEmbeddingProviderOptions = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      /**
       ...
       */
      content: v4.z.array(v4.z.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
    })
  )
);
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
      schema: googleGenerativeAIEmbeddingProviderOptions
    });
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkZFOCQ6NW_cjs.TooManyEmbeddingValuesForCallError({
        provider: this.provider,
        modelId: this.modelId,
    ...
    const mergedHeaders = chunkZFOCQ6NW_cjs.combineHeaders(
      await chunkZFOCQ6NW_cjs.resolve(this.config.headers),
      headers
    );
...
var googleGenerativeAITextEmbeddingResponseSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
            ...
            case "file": {
              ...
              parts.push(
                part.data instanceof URL ? {
                  ...
                  inlineData: {
                    mimeType: mediaType,
                    data: chunkZFOCQ6NW_cjs.convertToBase64(part.data)
                  }
                }
              );
              break;
...
var googleGenerativeAIProviderOptions = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      ...
      thinkingConfig: v4.z.object({
        ...
        thinkingLevel: v4.z.enum(["minimal", "low", "medium", "high"]).optional()
      }).optional(),
      /**
       * Optional.
       ...
       */
      imageConfig: v4.z.object({
        aspectRatio: v4.z.enum([
          "1:1",
          "2:3",
          "3:2",
          "3:4",
        ...
        imageSize: v4.z.enum(["1K", "2K", "4K", "512"]).optional()
      }).optional(),
      /**
       ...
       */
      retrievalConfig: v4.z.object({
        latLng: v4.z.object({
          latitude: v4.z.number(),
          longitude: v4.z.number()
        }).optional()
      }).optional(),
      /**
       * Optional. The service tier to use for the request.
       */
      serviceTier: v4.z.enum(["standard", "flex", "priority"]).optional()
    })
  )
);
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a = config.generateId) != null ? _a : chunkZFOCQ6NW_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createJsonResponseHandler(responseSchema),
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunkZFOCQ6NW_cjs.combineHeaders(
      await chunkZFOCQ6NW_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
...
var getGroundingMetadataSchema = () => v4.z.object({
  webSearchQueries: v4.z.array(v4.z.string()).nullish(),
  imageSearchQueries: v4.z.array(v4.z.string()).nullish(),
  retrievalQueries: v4.z.array(v4.z.string()).nullish(),
  searchEntryPoint: v4.z.object({ renderedContent: v4.z.string() }).nullish(),
  groundingChunks: v4.z.array(
    v4.z.object({
      web: v4.z.object({ uri: v4.z.string(), title: v4.z.string().nullish() }).nullish(),
      image: v4.z.object({
        sourceUri: v4.z.string(),
        imageUri: v4.z.string(),
        title: v4.z.string().nullish(),
        domain: v4.z.string().nullish()
      }).nullish(),
      retrievedContext: v4.z.object({
        uri: v4.z.string().nullish(),
        title: v4.z.string().nullish(),
        text: v4.z.string().nullish(),
        fileSearchStore: v4.z.string().nullish()
      }).nullish(),
      maps: v4.z.object({
        uri: v4.z.string().nullish(),
        title: v4.z.string().nullish(),
        text: v4.z.string().nullish(),
        placeId: v4.z.string().nullish()
      }).nullish()
    })
  ).nullish(),
...
var getContentSchema = () => v4.z.object({
  parts: v4.z.array(
    v4.z.union([
...
var getSafetyRatingSchema = () => v4.z.object({
...
var tokenDetailsSchema = v4.z.array(
  v4.z.object({
    modality: v4.z.string(),
    tokenCount: v4.z.number()
  })
).nullish();
var usageSchema = v4.z.object({
  ...
  trafficType: v4.z.string().nullish(),
  // https://ai.google.dev/api/generate-content#Modality
  promptTokensDetails: tokenDetailsSchema,
  candidatesTokensDetails: tokenDetailsSchema
});
var getUrlContextMetadataSchema = () => v4.z.object({
  urlMetadata: v4.z.array(
    v4.z.object({
...
var responseSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
          content: getContentSchema().nullish().or(v4.z.object({}).strict()),
          finishReason: v4.z.string().nullish(),
          safetyRatings: v4.z.array(getSafetyRatingSchema()).nullish(),
          groundingMetadata: getGroundingMetadataSchema().nullish(),
          urlContextMetadata: getUrlContextMetadataSchema().nullish()
        })
      ),
      usageMetadata: usageSchema.nullish(),
      promptFeedback: v4.z.object({
        blockReason: v4.z.string().nullish(),
        safetyRatings: v4.z.array(getSafetyRatingSchema()).nullish()
      }).nullish(),
      serviceTier: v4.z.string().nullish()
    })
  )
);
var chunkSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
...
var codeExecution = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var enterpriseWebSearch = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
  id: "google.enterprise_web_search",
  name: "enterprise_web_search",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema(() => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({})))
});
var fileSearchArgsBaseSchema = v4.z.object({
  /** The names of the file_search_stores to retrieve from.
   *  Example: `fileSearchStores/my-file-search-store-123`
   */
  fileSearchStoreNames: v4.z.array(v4.z.string()).describe(
    "The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"
  ),
  /** The number of file search retrieval chunks to retrieve. */
  topK: v4.z.number().int().positive().describe("The number of file search retrieval chunks to retrieve.").optional(),
  /** Metadata filter to apply to the file search retrieval documents.
   *  See https://google.aip.dev/160 for the syntax of the filter expression.
   */
  metadataFilter: v4.z.string().describe(
    "Metadata filter to apply to the file search retrieval documents. See https://google.aip.dev/160 for the syntax of the filter expression."
  ).optional()
}).passthrough();
var fileSearchArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(fileSearchArgsBaseSchema)
);
var fileSearch = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
  id: "google.file_search",
  name: "file_search",
  inputSchema: fileSearchArgsSchema
});
var googleMaps = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
...
var googleSearchToolArgsBaseSchema = v4.z.object({
  searchTypes: v4.z.object({
    webSearch: v4.z.object({}).optional(),
    imageSearch: v4.z.object({}).optional()
  }).optional(),
  timeRangeFilter: v4.z.object({
    startTime: v4.z.string(),
    endTime: v4.z.string()
  }).optional()
}).passthrough();
var googleSearchToolArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(googleSearchToolArgsBaseSchema)
);
var googleSearch = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
  id: "google.google_search",
  name: "google_search",
  inputSchema: googleSearchToolArgsSchema
});
var urlContext = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
  id: "google.url_context",
  name: "url_context",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema(() => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({})))
});
var vertexRagStore = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactory({
  id: "google.vertex_rag_store",
  name: "vertex_rag_store",
  inputSchema: v4.z.object({
    ragCorpus: v4.z.string(),
    topK: v4.z.number().optional()
  })
});
var googleTools = {
  /**
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi({
      ...
      headers: chunkZFOCQ6NW_cjs.combineHeaders(await chunkZFOCQ6NW_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createJsonResponseHandler(
...
var googleImageResponseSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var googleImageProviderOptionsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkZFOCQ6NW_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix(
    {
      "x-goog-api-key": chunkZFOCQ6NW_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunkZFOCQ6NW_cjs.generateId,
      supportedUrls: () => ({
        "*": [
...
var openaiFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler({
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: {
                      url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkZFOCQ6NW_cjs.convertToBase64(part.data)}`,
                  ...
                  return {
                    ...
                    file: typeof part.data === "string" && part.data.startsWith("file-") ? { file_id: part.data } : {
                      ...
                      file_data: `data:application/pdf;base64,${chunkZFOCQ6NW_cjs.convertToBase64(part.data)}`
                    }
                  };
                } else {
                  throw new chunkZFOCQ6NW_cjs.UnsupportedFunctionalityError({
...
var openaiChatResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var openaiChatChunkSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      /**
       ...
       */
      reasoningEffort: v4.z.enum(["none", "minimal", "low", "medium", "high", "xhigh"]).optional(),
      /**
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b, _c, _d;
    const warnings = [];
    const openaiOptions = (_a = await chunkZFOCQ6NW_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    for (const toolCall of (_a = choice.message.tool_calls) != null ? _a : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b = toolCall.id) != null ? _b : chunkZFOCQ6NW_cjs.generateId(),
    ...
    for (const annotation of (_c = choice.message.annotations) != null ? _c : []) {
      content.push({
        type: "source",
        sourceType: "url",
        id: chunkZFOCQ6NW_cjs.generateId(),
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_o = toolCall2.function) == null ? void 0 : _o.name) != null && ((_p = toolCall2.function) == null ? void 0 : _p.arguments) != null) {
                    ...
                    if (chunkZFOCQ6NW_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_q = toolCall2.id) != null ? _q : chunkZFOCQ6NW_cjs.generateId(),
                ...
                if (((_v = toolCall.function) == null ? void 0 : _v.name) != null && ((_w = toolCall.function) == null ? void 0 : _w.arguments) != null && chunkZFOCQ6NW_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_x = toolCall.id) != null ? _x : chunkZFOCQ6NW_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkZFOCQ6NW_cjs.InvalidPromptError({
...
var openaiCompletionResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAICompletionLanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openaiOptions = {
      ...await chunkZFOCQ6NW_cjs.parseProviderOptions({
        provider: "openai",
        providerOptions,
...
var openaiEmbeddingProviderOptions = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      /**
...
var openaiTextEmbeddingResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var openaiImageResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
      ...
      background: v4.z.string().nullish(),
      output_format: v4.z.string().nullish(),
      size: v4.z.string().nullish(),
      quality: v4.z.string().nullish(),
      usage: v4.z.object({
        input_tokens: v4.z.number().nullish(),
        output_tokens: v4.z.number().nullish(),
        total_tokens: v4.z.number().nullish(),
...
var baseImageModelOptionsObject = v4.z.object({
  /**
   * Quality of the generated image(s).
   *
   * Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
   */
  quality: v4.z.enum(["standard", "hd", "low", "medium", "high", "auto"]).optional(),
  /**
   ...
   * (i.e. `png` or `webp`).
   */
  background: v4.z.enum(["transparent", "opaque", "auto"]).optional(),
  /**
...
chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(baseImageModelOptionsObject)
);
var openaiImageModelGenerationOptions = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    baseImageModelOptionsObject.extend({
       ...
       * looking images.
       */
      style: v4.z.enum(["vivid", "natural"]).optional(),
      /**
       * Content moderation level for the generated image(s). `low` applies
       * less restrictive filtering.
       */
      moderation: v4.z.enum(["auto", "low"]).optional()
    })
  )
);
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a = this.config._internal) == null ? void 0 : _a.currentDate) == null ? void 0 : _b.call(_a)) != null ? _c : /* @__PURE__ */ new Date();
    const openaiOptions = (_d = await chunkZFOCQ6NW_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
...
var codeInterpreterInputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
...
var codeInterpreterArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterToolFactory = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var comparisonFilterSchema = v4.z.object({
  key: v4.z.string(),
  type: v4.z.enum(["eq", "ne", "gt", "gte", "lt", "lte", "in", "nin"]),
  value: v4.z.union([v4.z.string(), v4.z.number(), v4.z.boolean(), v4.z.array(v4.z.string())])
});
...
var fileSearchArgsSchema2 = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var fileSearchOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var fileSearch2 = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var imageGenerationArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var imageGenerationInputSchema = chunkZFOCQ6NW_cjs.lazySchema(() => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var localShellInputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
...
var localShellOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
var localShell = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.local_shell",
  name: "local_shell",
  inputSchema: localShellInputSchema,
  outputSchema: localShellOutputSchema
});
var webSearchArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var webSearchInputSchema = chunkZFOCQ6NW_cjs.lazySchema(() => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        ...
        v4.z.object({
          type: v4.z.literal("findInPage"),
          url: v4.z.string().nullish(),
          pattern: v4.z.string().nullish()
        })
      ]).optional(),
      sources: v4.z.array(
        v4.z.discriminatedUnion("type", [
...
var webSearchToolFactory = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var webSearchPreviewArgsSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview = chunkZFOCQ6NW_cjs.createProviderDefinedToolFactoryWithOutputSchema({
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${chunkZFOCQ6NW_cjs.convertToBase64(part.data)}`
                    },
          ...
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                const parsedInput = await chunkZFOCQ6NW_cjs.validateTypes({
                  value: part.input,
            ...
            case "reasoning": {
              const providerOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions({
                provider: "openai",
      ...
      case "tool": {
        for (const part of content) {
          ...
          if (hasLocalShellTool && part.toolName === "local_shell" && output.type === "json") {
            const parsedOutput = await chunkZFOCQ6NW_cjs.validateTypes({
              value: output.value,
...
var openaiResponsesChunkSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
      ...
      v4.z.object({
        ...
        item: v4.z.discriminatedUnion("type", [
          v4.z.object({
            ...
            id: v4.z.string(),
            phase: v4.z.enum(["commentary", "final_answer"]).nullish()
          }),
          v4.z.object({
        ...
        item: v4.z.discriminatedUnion("type", [
          ...
          v4.z.object({
            ...
            action: v4.z.discriminatedUnion("type", [
              ...
              v4.z.object({
                type: v4.z.literal("find_in_page"),
                url: v4.z.string().nullish(),
                pattern: v4.z.string().nullish()
              })
            ]).nullish()
...
var openaiResponsesResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
...
var openaiResponsesProviderOptionsSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      ...
      case "provider-defined": {
        switch (tool.id) {
          case "openai.file_search": {
            const args = await chunkZFOCQ6NW_cjs.validateTypes({
              value: tool.args,
...
var OpenAIResponsesLanguageModel = class {
  ...
  async getArgs({
    ...
    const openaiOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunkZFOCQ6NW_cjs.APICallError({
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                content.push({
                  type: "source",
                  sourceType: "url",
                  id: (_f = (_e = (_d = this.config).generateId) == null ? void 0 : _e.call(_d)) != null ? _f : chunkZFOCQ6NW_cjs.generateId(),
                  url: annotation.url,
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_i = (_h = (_g = this.config).generateId) == null ? void 0 : _h.call(_g)) != null ? _i : chunkZFOCQ6NW_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : chunkZFOCQ6NW_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = this.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkZFOCQ6NW_cjs.generateId(),
                  mediaType: "application/octet-stream",
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_r = (_q = (_p = self.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : chunkZFOCQ6NW_cjs.generateId(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = self.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkZFOCQ6NW_cjs.generateId(),
                  mediaType: "text/plain",
...
var openaiSpeechProviderOptionsSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      instructions: v4.z.string().nullish(),
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
var openaiTranscriptionResponseSchema = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
...
var openAITranscriptionProviderOptions = chunkZFOCQ6NW_cjs.lazyValidator(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkZFOCQ6NW_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkZFOCQ6NW_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkZFOCQ6NW_cjs.postFormDataToApi({
      url: this.config.url({
...
var VERSION2 = "2.0.106" ;
function createOpenAI2(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkZFOCQ6NW_cjs.withoutTrailingSlash(
    chunkZFOCQ6NW_cjs.loadOptionalSetting({
...
function getMastraGatewayBaseUrl(raw = process.env["MASTRA_GATEWAY_URL"]) {
  ...
  const withoutVersion = withoutTrailingSlashes.endsWith("/v1") ? withoutTrailingSlashes.slice(0, -"/v1".length) : withoutTrailingSlashes;
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.providerId === MASTRA_GATEWAY_ID) {
      ...
      this.providerModel = chunkZFOCQ6NW_cjs.createOpenAICompatible({
        name: MASTRA_GATEWAY_ID,
        apiKey,
        baseURL: getMastraGatewayBaseUrl(normalizedConfig.url),
        headers: {
          "User-Agent": chunkZFOCQ6NW_cjs.MASTRA_USER_AGENT,
      ...
      const registry = chunkRWB3UEF4_cjs.GatewayRegistry.getInstance();
      ...
      if (normalizedConfig.providerId === "openai") {
        this.providerModel = createOpenAI2({ apiKey }).textEmbeddingModel(
...
exports.attachModelStreamTransport = attachModelStreamTransport;
exports.defaultGateways = defaultGateways;
exports.readModelStreamTransport = readModelStreamTransport;
exports.resolveModelAuth = resolveModelAuth;
exports.resolveModelConfig = resolveModelConfig;
//# sourceMappingURL=chunk-YLB2YBKQ.cjs.map
//# sourceMappingURL=chunk-YLB2YBKQ.cjs.map