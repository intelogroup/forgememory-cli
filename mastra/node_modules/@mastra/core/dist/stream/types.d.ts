import type { LanguageModelV2FinishReason, LanguageModelV2Usage, LanguageModelV2CallWarning, LanguageModelV2Prompt, LanguageModelV2ResponseMetadata, LanguageModelV2StreamPart } from '../_types/@ai-sdk_provider-v5/dist/index.d.ts';
import type { FinishReason, LanguageModelRequestMetadata, LogProbs as LanguageModelV1LogProbs } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
import type { CallSettings, ModelMessage, StepResult, ToolSet, TypedToolCall, UIMessage } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
import type { AIV5ResponseMessage } from '../agent/message-list/index.js';
import type { AIV5Type, MastraDBMessage } from '../agent/message-list/types.js';
import type { StructuredOutputOptions } from '../agent/types.js';
import type { MastraLanguageModel, SharedProviderOptions } from '../llm/model/shared.types.js';
import type { ScorerResult } from '../loop/index.js';
import type { ClientObservabilityCarrier, ObservabilityContext } from '../observability/index.js';
import type { OutputProcessorOrWorkflow } from '../processors/index.js';
import type { RequestContext } from '../request-context/index.js';
import type { WorkflowRunStatus, WorkflowStepStatus } from '../workflows/types.js';
import type { OutputSchema } from './base/schema.js';
export declare enum ChunkFrom {
    AGENT = "AGENT",
    USER = "USER",
    SYSTEM = "SYSTEM",
    WORKFLOW = "WORKFLOW",
...
export declare const MASTRA_MODEL_STREAM_TRANSPORT: unique symbol;
export type StreamTransportCarrier = {
    [key: symbol]: StreamTransport | undefined;
};
export declare function attachModelStreamTransport(target: object, transport?: StreamTransport): void;
export declare function readModelStreamTransport(target: unknown): StreamTransport | undefined;
...
export interface BackgroundTaskOutputPayload {
    ...
    runId: string;
    agentId: string;
    payload: Extract<AgentChunkType, {
        type: 'tool-output';
    }>;
}
...
export type NetworkChunkType<OUTPUT = undefined> = (BaseChunkType & {
...
export type AgentChunkType<OUTPUT = undefined> = (BaseChunkType & {
...
export type WorkflowStreamEvent = (BaseChunkType & {
    type: 'workflow-start';
    payload: {
        workflowId: string;
    };
...
export type TypedChunkType<OUTPUT = undefined> = AgentChunkType<OUTPUT> | WorkflowStreamEvent | NetworkChunkType<OUTPUT> | (DataChunkType & {
    from: never;
    runId: never;
...
export type MastraOnStepFinishCallback<OUTPUT = undefined> = (event: LLMStepResult<OUTPUT> & {
    model?: partialModel;
    runId?: string;
}) => Promise<void> | void;
...
export type MastraOnFinishCallback<OUTPUT = undefined> = (event: MastraOnFinishCallbackArgs<OUTPUT>) => Promise<void> | void;
