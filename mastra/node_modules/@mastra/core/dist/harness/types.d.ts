 ...
 */
export declare function defaultDisplayState(): HarnessDisplayState;
/**
...
export interface HarnessRequestContext<TState = unknown> {
    ...
    updateState?: <TResult>(updater: (state: Readonly<TState>) => {
