import { augmentWithInit, Workspace } from '../../chunk-5YZI33XV.js';
import { createTool } from '../../chunk-LCWNYZTU.js';
  ...
  return {
    ...
    ask_user: createTool({
      ...
      inputSchema: z.object({
        question: z.string(),
        options: z.array(z.object({ label: z.string(), description: z.string().nullable().optional() })).min(2).max(4).optional().nullable(),
...
export { EventEmitter, Harness, HarnessSkillNotFoundError, Session, formatHarnessEventId, parseHarnessEventId };
