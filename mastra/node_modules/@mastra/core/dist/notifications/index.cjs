...
var notificationActionSchema = v4.z.object({
  action: v4.z.enum(["list", "read", "markSeen", "dismiss", "archive", "search"]),
  threadId: v4.z.string().optional(),
  id: v4.z.string().optional(),
  status: v4.z.enum(["pending", "delivered", "seen", "dismissed", "archived", "discarded"]).optional(),
  priority: v4.z.enum(["low", "medium", "high", "urgent"]).optional(),
  source: v4.z.string().optional(),
  query: v4.z.string().optional(),
  limit: v4.z.number().int().positive().optional()
});
...
async function deliverNotifications({
  ...
  for (const notification of notifications) {
    ...
    if (agent && resourceId && !notification.deliveredSignalId) {
      const signal = chunkO3IPVE45_cjs.createNotificationSignal({ ...notification, status: "delivered" });
...
Object.defineProperty(exports, "defaultNotificationDeliveryDecision", {
  enumerable: true,
  get: function () { return chunk6ZBUYPOD_cjs.defaultNotificationDeliveryDecision; }
});
Object.defineProperty(exports, "resolveNotificationDeliveryDecision", {
  enumerable: true,
  get: function () { return chunk6ZBUYPOD_cjs.resolveNotificationDeliveryDecision; }
});
...
Object.defineProperty(exports, "createNotificationSignal", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.createNotificationSignal; }
});
Object.defineProperty(exports, "createNotificationSummarySignal", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.createNotificationSummarySignal; }
});
...
Object.defineProperty(exports, "notificationSignalAttributes", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.notificationSignalAttributes; }
});
Object.defineProperty(exports, "notificationSignalMetadata", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.notificationSignalMetadata; }
});
Object.defineProperty(exports, "notificationSummaryContents", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.notificationSummaryContents; }
});
Object.defineProperty(exports, "notificationSummarySignalMetadata", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.notificationSummarySignalMetadata; }
});
Object.defineProperty(exports, "summarizeNotifications", {
  enumerable: true,
  get: function () { return chunkO3IPVE45_cjs.summarizeNotifications; }
});
