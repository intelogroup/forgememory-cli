...
function validateUpsertInput(storeName, vectors, metadata, ids) {
  if (!vectors || vectors.length === 0) {
    throw new chunkXSOONORA_cjs.MastraError({
      id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "UPSERT", "EMPTY_VECTORS"),
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkXSOONORA_cjs.ErrorCategory.USER,
      details: {
  ...
  if (metadata && metadata.length > 0 && metadata.length !== vectors.length) {
    throw new chunkXSOONORA_cjs.MastraError({
      id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "UPSERT", "METADATA_LENGTH_MISMATCH"),
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkXSOONORA_cjs.ErrorCategory.USER,
      details: {
  ...
  if (ids && ids.length !== vectors.length) {
    throw new chunkXSOONORA_cjs.MastraError({
      id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "UPSERT", "IDS_LENGTH_MISMATCH"),
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkXSOONORA_cjs.ErrorCategory.USER,
      details: {
...
function validateTopK(storeName, topK) {
  if (!Number.isInteger(topK) || topK <= 0) {
    throw new chunkXSOONORA_cjs.MastraError({
      id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "QUERY", "INVALID_TOP_K"),
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
      category: chunkXSOONORA_cjs.ErrorCategory.USER,
      details: {
...
function validateVectorValues(storeName, vectors) {
  for (let i = 0; i < vectors.length; i++) {
    ...
    if (!vector) {
      throw new chunkXSOONORA_cjs.MastraError({
        id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR"),
        domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
        category: chunkXSOONORA_cjs.ErrorCategory.USER,
        details: {
    ...
    for (let j = 0; j < vector.length; j++) {
      ...
      if (value === null || value === void 0 || !Number.isFinite(value)) {
        throw new chunkXSOONORA_cjs.MastraError({
          id: chunkO3IPVE45_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR_VALUE"),
          domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_VECTOR,
          category: chunkXSOONORA_cjs.ErrorCategory.USER,
          details: {
...
Object.defineProperty(exports, "embedV2", {
  enumerable: true,
  get: function () { return chunkPWQW5NYR_cjs.embed; }
});
