import { MastraFGAPermissions } from './chunk-YZJTGAQU.js';
import { Tool, isVercelTool, isProviderDefinedTool, validateToolInput, getNeedsApprovalFn, validateToolOutput, validateToolSuspendData } from './chunk-LCWNYZTU.js';
...
import { wrapMastra, createObservabilityContext } from './chunk-IX6V357L.js';
import { getOrCreateSpan, EntityType, executeWithContext } from './chunk-DEQCJWZZ.js';
import { backgroundOverrideZodSchema, backgroundOverrideJsonSchema } from './chunk-EWCGKWQ6.js';
...
var CoreToolBuilder = class extends MastraBase {
  ...
  createExecute(tool, options, logType) {
    ...
    return async (args, execOptions) => {
      ...
      if (fgaProvider) {
        const { getAgentToolFGAResourceId, getMCPToolFGAResourceId, getStandaloneToolFGAResourceId, requireFGA } = await import('./fga-check-CKQJDJVB.js');
...
//# sourceMappingURL=chunk-VA4S6KHU.js.map
//# sourceMappingURL=chunk-VA4S6KHU.js.map