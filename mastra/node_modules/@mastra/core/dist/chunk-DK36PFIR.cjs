...
var chunkZFOCQ6NW_cjs = require('./chunk-ZFOCQ6NW.cjs');
...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunkZFOCQ6NW_cjs.UnsupportedFunctionalityError2({
...
var alibabaFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler2({
...
function formatImageUrl({
  ...
  return data instanceof URL ? data.toString() : `data:${mediaType};base64,${chunkZFOCQ6NW_cjs.convertToBase642(data)}`;
}
...
var AlibabaLanguageModel = class {
  ...
  async getArgs({
    ...
    const alibabaOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions2({
      provider: "alibaba",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunkZFOCQ6NW_cjs.combineHeaders2(this.config.headers(), options.headers),
      body: args,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createJsonResponseHandler2(
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/chat/completions`,
      headers: chunkZFOCQ6NW_cjs.combineHeaders2(this.config.headers(), options.headers),
      body,
      failedResponseHandler: alibabaFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createEventSourceResponseHandler2(
          ...
          transform(chunk, controller) {
            ...
            if (delta.reasoning_content != null && delta.reasoning_content.length > 0) {
              if (activeReasoningId == null) {
                ...
                activeReasoningId = chunkZFOCQ6NW_cjs.generateId2();
                controller.enqueue({
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkZFOCQ6NW_cjs.InvalidResponseDataError2({
                      data: toolCallDelta,
                  ...
                  if (chunkZFOCQ6NW_cjs.isParsableJson2(toolCall2.function.arguments)) {
                    controller.enqueue({
                      type: "tool-input-end",
                      id: toolCall2.id
                    });
                ...
                if (chunkZFOCQ6NW_cjs.isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
...
var alibabaVideoModelOptionsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var alibabaVideoFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler2({
  ...
  async doGenerate(options) {
    ...
    if (mode === "i2v" && options.image != null) {
      if (options.image.type === "url") {
        ...
        const base64Data = typeof options.image.data === "string" ? options.image.data : chunkZFOCQ6NW_cjs.convertUint8ArrayToBase642(options.image.data);
    ...
    const { value: createResponse } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
      url: `${this.config.baseURL}/api/v1/services/aigc/video-generation/video-synthesis`,
      headers: chunkZFOCQ6NW_cjs.combineHeaders2(
        await chunkZFOCQ6NW_cjs.resolve2(this.config.headers),
        options.headers,
        {
    ...
    if (!taskId) {
      throw new chunkZFOCQ6NW_cjs.AISDKError({
    ...
    let responseHeaders;
    while (true) {
      await chunkZFOCQ6NW_cjs.delay(pollIntervalMs, { abortSignal: options.abortSignal });
      ...
      const { value: statusResponse, responseHeaders: pollHeaders } = await chunkZFOCQ6NW_cjs.getFromApi({
...
function createAlibaba(options = {}) {
  var _a15, _b;
  const baseURL = (_a15 = chunkZFOCQ6NW_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
  const videoBaseURL = (_b = chunkZFOCQ6NW_cjs.withoutTrailingSlash2(options.videoBaseURL)) != null ? _b : "https://dashscope-intl.aliyuncs.com";
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkZFOCQ6NW_cjs.loadApiKey2({
  ...
  provider.imageModel = (modelId) => {
    throw new chunkZFOCQ6NW_cjs.NoSuchModelError2({ modelId, modelType: "imageModel" });
  };
  provider.embeddingModel = (modelId) => {
    throw new chunkZFOCQ6NW_cjs.NoSuchModelError2({ modelId, modelType: "embeddingModel" });
  };
  return provider;
}
createAlibaba();
...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunkZFOCQ6NW_cjs.withoutTrailingSlash(
    (_a15 = options.baseURL) != null ? _a15 : "https://api.cerebras.ai/v1"
  );
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkZFOCQ6NW_cjs.loadApiKey({
        apiKey: options.apiKey,
  ...
  const createLanguageModel = (modelId) => {
    return new chunkZFOCQ6NW_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkZFOCQ6NW_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunkZFOCQ6NW_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const currentDate = (_c = (_b = (_a15 = this.config._internal) == null ? void 0 : _a15.currentDate) == null ? void 0 : _b.call(_a15)) != null ? _c : /* @__PURE__ */ new Date();
    const { value: response, responseHeaders } = await chunkZFOCQ6NW_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${this.modelId}`,
      headers: chunkZFOCQ6NW_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        prompt,
        num_images: n,
      ...
      failedResponseHandler: chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler({
        errorSchema: deepInfraErrorSchema,
        errorToMessage: (error) => error.detail.error
      }),
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createJsonResponseHandler(
...
var DeepInfraChatLanguageModel = class extends chunkZFOCQ6NW_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunkZFOCQ6NW_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunkZFOCQ6NW_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunkZFOCQ6NW_cjs.lazySchema(
  () => chunkZFOCQ6NW_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
        created: v4.z.number().nullish(),
...
function prepareTools2({
  ...
  switch (type) {
    ...
    default: {
      const _exhaustiveCheck = type;
      throw new chunkZFOCQ6NW_cjs.UnsupportedFunctionalityError({
        functionality: `tool choice type: ${_exhaustiveCheck}`
      });
    }
  }
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunkZFOCQ6NW_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      value: responseBody,
      rawValue: rawResponse
    } = await chunkZFOCQ6NW_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkZFOCQ6NW_cjs.combineHeaders(this.config.headers(), options.headers),
      body: args,
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkZFOCQ6NW_cjs.generateId(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: this.failedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createEventSourceResponseHandler(
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkZFOCQ6NW_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                      message: `Expected 'id' to be a string.`
                    });
                  }
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkZFOCQ6NW_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkZFOCQ6NW_cjs.generateId(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkZFOCQ6NW_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkZFOCQ6NW_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkZFOCQ6NW_cjs.convertToBase642(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler2({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b, _c;
    const warnings = [];
    const groqOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions2({
      provider: "groq",
      providerOptions,
    ...
    const {
      ...
      toolWarnings
    } = prepareTools3({ tools, toolChoice, modelId: this.modelId });
    return {
      args: {
        // model id:
        model: this.modelId,
  ...
  async doGenerate(options) {
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkZFOCQ6NW_cjs.generateId2(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments
        });
      }
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createEventSourceResponseHandler2(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_d = toolCall2.function) == null ? void 0 : _d.name) != null && ((_e = toolCall2.function) == null ? void 0 : _e.arguments) != null) {
                    ...
                    if (chunkZFOCQ6NW_cjs.isParsableJson2(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_f = toolCall2.id) != null ? _f : chunkZFOCQ6NW_cjs.generateId2(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_k = toolCall.function) == null ? void 0 : _k.name) != null && ((_l = toolCall.function) == null ? void 0 : _l.arguments) != null && chunkZFOCQ6NW_cjs.isParsableJson2(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_m = toolCall.id) != null ? _m : chunkZFOCQ6NW_cjs.generateId2(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var groqTranscriptionModelOptions = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkZFOCQ6NW_cjs.convertBase64ToUint8Array2(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkZFOCQ6NW_cjs.mediaTypeToExtension2(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkZFOCQ6NW_cjs.postFormDataToApi2({
      url: this.config.url({
...
var browserSearch = chunkZFOCQ6NW_cjs.createProviderToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkZFOCQ6NW_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkZFOCQ6NW_cjs.loadApiKey2({
        apiKey: options.apiKey,
...
function convertMistralUsage(usage) {
  ...
  const cacheReadTokens = (_e = (_d = (_b = usage.num_cached_tokens) != null ? _b : (_a15 = usage.prompt_tokens_details) == null ? void 0 : _a15.cached_tokens) != null ? _d : (_c = usage.prompt_token_details) == null ? void 0 : _c.cached_tokens) != null ? _e : 0;
  return {
    inputTokens: {
      total: promptTokens,
      noCache: promptTokens - cacheReadTokens,
...
var mistralLanguageModelOptions = v4.z.object({
   ...
   */
  reasoningEffort: v4.z.enum(["high", "none"]).optional()
});
...
var mistralFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler2({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunkZFOCQ6NW_cjs.generateId2;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunkZFOCQ6NW_cjs.parseProviderOptions2({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunkZFOCQ6NW_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
  ...
  v4.z.array(
    v4.z.discriminatedUnion("type", [
      ...
      v4.z.object({
        ...
        reference_ids: v4.z.array(v4.z.union([v4.z.string(), v4.z.number()]))
      }),
      v4.z.object({
...
var mistralUsageSchema = v4.z.object({
  ...
  completion_tokens: v4.z.number(),
  total_tokens: v4.z.number(),
  num_cached_tokens: v4.z.number().nullish(),
  prompt_tokens_details: v4.z.object({ cached_tokens: v4.z.number().nullish() }).nullish(),
  prompt_token_details: v4.z.object({ cached_tokens: v4.z.number().nullish() }).nullish()
});
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkZFOCQ6NW_cjs.TooManyEmbeddingValuesForCallError2({
    ...
    const {
      ...
      headers: chunkZFOCQ6NW_cjs.combineHeaders2(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkZFOCQ6NW_cjs.withoutTrailingSlash2(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix2(
    {
      Authorization: `Bearer ${chunkZFOCQ6NW_cjs.loadApiKey2({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunkZFOCQ6NW_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunkZFOCQ6NW_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
var perplexityCostSchema = v4.z.object({
  input_tokens_cost: v4.z.number().nullish(),
  output_tokens_cost: v4.z.number().nullish(),
  request_cost: v4.z.number().nullish(),
  total_cost: v4.z.number().nullish()
});
...
function createPerplexity(options = {}) {
  const getHeaders = () => chunkZFOCQ6NW_cjs.withUserAgentSuffix(
    ...
    `ai-sdk/perplexity/${VERSION7}`
  );
  const createLanguageModel = (modelId) => {
    var _a15;
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunkZFOCQ6NW_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunkZFOCQ6NW_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const getHeaders = () => {
    var _a22;
    return chunkZFOCQ6NW_cjs.withUserAgentSuffix(
      {
        Authorization: `Bearer ${chunkZFOCQ6NW_cjs.loadApiKey({
  ...
  const createChatModel = (modelId) => {
    return new chunkZFOCQ6NW_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
function convertXaiChatUsage(usage) {
  var _a15, _b, _c, _d;
  const cacheReadTokens = (_b = (_a15 = usage.prompt_tokens_details) == null ? void 0 : _a15.cached_tokens) != null ? _b : 0;
...
var xaiLanguageModelChatOptions = v4.z.object({
  reasoningEffort: v4.z.enum(["low", "high"]).optional(),
  logprobs: v4.z.boolean().optional(),
  topLogprobs: v4.z.number().int().min(0).max(8).optional(),
  /**
   * Whether to enable parallel function calling during tool use.
...
var xaiFailedResponseHandler = chunkZFOCQ6NW_cjs.createJsonErrorResponseHandler2({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunkZFOCQ6NW_cjs.APICallError2({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunkZFOCQ6NW_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunkZFOCQ6NW_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunkZFOCQ6NW_cjs.createEventSourceResponseHandler2(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
...
var xaiImageModelOptions = v4.z.object({
  aspect_ratio: v4.z.string().optional(),
  output_format: v4.z.string().optional(),
  sync_mode: v4.z.boolean().optional(),
  resolution: v4.z.enum(["1k", "2k"]).optional(),
  quality: v4.z.enum(["low", "medium", "high"]).optional(),
  user: v4.z.string().optional()
});
var XaiImageModel = class {
  ...
  async doGenerate({
    ...
    const xaiOptions = await chunkZFOCQ6NW_cjs.parseProviderOptions2({
      provider: "xai",
      providerOptions,
      schema: xaiImageModelOptions
    });
    const hasFiles = files != null && files.length > 0;
    const imageUrls = hasFiles ? files.map((file) => chunkZFOCQ6NW_cjs.convertImageModelFileToDataUri(file)) : [];
    ...
    const { value: response, responseHeaders } = await chunkZFOCQ6NW_cjs.postJsonToApi2({
  ...
  async downloadImage(url, abortSignal) {
    const { value } = await chunkZFOCQ6NW_cjs.getFromApi({
      url,
      abortSignal,
      failedResponseHandler: chunkZFOCQ6NW_cjs.createStatusCodeErrorResponseHandler(),
      successfulResponseHandler: chunkZFOCQ6NW_cjs.createBinaryResponseHandler2(),
      fetch: this.config.fetch
    });
    return value;
  }
};
var xaiImageResponseSchema = v4.z.object({
  data: v4.z.array(
    v4.z.object({
      url: v4.z.string().nullish(),
      b64_json: v4.z.string().nullish(),
      revised_prompt: v4.z.string().nullish()
    })
  ),
  usage: v4.z.object({
    cost_in_usd_ticks: v4.z.number().nullish()
  }).nullish()
});
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunkZFOCQ6NW_cjs.convertToBase642(block.data)}`;
...
function convertXaiResponsesUsage(usage) {
  var _a15, _b, _c, _d;
  const cacheReadTokens = (_b = (_a15 = usage.input_tokens_details) == null ? void 0 : _a15.cached_tokens) != null ? _b : 0;
...
var mcpCallSchema = v4.z.object({
  name: v4.z.string().optional(),
  arguments: v4.z.string().optional(),
  output: v4.z.string().optional(),
  error: v4.z.string().optional(),
  id: v4.z.string(),
  status: v4.z.string(),
  server_label: v4.z.string().optional()
});
var outputItemSchema = v4.z.discriminatedUnion("type", [
  ...
  v4.z.object({
    ...
    id: v4.z.string(),
    status: v4.z.string(),
    queries: v4.z.array(v4.z.string()).optional(),
    results: v4.z.array(
      v4.z.object({
        file_id: v4.z.string(),
...
var xaiResponsesChunkSchema = v4.z.union([
  ...
  v4.z.object({
    type: v4.z.literal("response.file_search_call.in_progress"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.file_search_call.searching"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.file_search_call.completed"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
  ...
  v4.z.object({
    type: v4.z.literal("response.function_call_arguments.done"),
    item_id: v4.z.string(),
    output_index: v4.z.number(),
    arguments: v4.z.string()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call.in_progress"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call.executing"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call.completed"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call.failed"),
    item_id: v4.z.string(),
    output_index: v4.z.number()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call_arguments.delta"),
    item_id: v4.z.string(),
    output_index: v4.z.number(),
    delta: v4.z.string()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call_arguments.done"),
    item_id: v4.z.string(),
    output_index: v4.z.number(),
    arguments: v4.z.string().optional()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call_output.delta"),
    item_id: v4.z.string(),
    output_index: v4.z.number(),
    delta: v4.z.string()
  }),
  v4.z.object({
    type: v4.z.literal("response.mcp_call_output.done"),
    item_id: v4.z.string(),
    output_index: v4.z.number(),
    output: v4.z.string().optional()
  }),
  v4.z.object({
    type: v4.z.literal("response.incomplete"),
  ...
  v4.z.object({
    type: v4.z.literal("response.failed"),
    response: v4.z.object({
      error: v4.z.object({
        code: v4.z.string().nullish(),
        message: v4.z.string()
...
var xaiLanguageModelResponsesOptions = v4.z.object({
  /**
...
var fileSearchArgsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchOutputSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var fileSearchToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.file_search",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema2(() => chunkZFOCQ6NW_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: fileSearchOutputSchema
});
var fileSearch = (args) => fileSearchToolFactory(args);
var mcpServerArgsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
      ...
      serverDescription: v4.z.string().optional().describe("Description of the MCP server"),
      allowedTools: v4.z.array(v4.z.string()).optional().describe("List of allowed tool names"),
      headers: v4.z.record(v4.z.string(), v4.z.string()).optional().describe("Custom headers to send"),
      authorization: v4.z.string().optional().describe("Authorization header value")
    })
  )
);
var mcpServerOutputSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
      name: v4.z.string(),
      arguments: v4.z.string(),
...
var mcpServerToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.mcp",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema2(() => chunkZFOCQ6NW_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: mcpServerOutputSchema
});
var mcpServer = (args) => mcpServerToolFactory(args);
var webSearchArgsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var webSearchOutputSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.web_search",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema2(() => chunkZFOCQ6NW_cjs.zodSchema2(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
...
var xSearchOutputSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.x_search",
  inputSchema: chunkZFOCQ6NW_cjs.lazySchema2(() => chunkZFOCQ6NW_cjs.zodSchema2(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunkZFOCQ6NW_cjs.validateTypes2({
            value: tool.args,
    ...
    return {
      stream: response.pipeThrough(
        new TransformStream({
          ...
          transform(chunk, controller) {
            var _a22, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o;
            if (options.includeRawChunks) {
              controller.enqueue({ type: "raw", rawValue: chunk.rawValue });
            }
            if (!chunk.success) {
            ...
            if (event.type === "response.created" || event.type === "response.in_progress") {
              if (isFirstChunk) {
                controller.enqueue({
                  type: "response-metadata",
                  ...getResponseMetadata6(event.response)
                });
                isFirstChunk = false;
              }
              return;
...
var codeExecutionToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunkZFOCQ6NW_cjs.createProviderToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var VERSION9 = "3.0.89" ;
var nonEmptyStringSchema = v4.z.string().min(1);
var resolutionSchema = v4.z.enum(["480p", "720p"]);
var modeSchema = v4.z.enum(["edit-video", "extend-video", "reference-to-video"]);
var baseFields = {
  pollIntervalMs: v4.z.number().positive().nullish(),
  pollTimeoutMs: v4.z.number().positive().nullish(),
  resolution: resolutionSchema.nullish()
};
var editVideoSchema = v4.z.object({
  ...baseFields,
  mode: v4.z.literal("edit-video"),
  videoUrl: nonEmptyStringSchema,
  referenceImageUrls: v4.z.undefined().optional()
});
var extendVideoSchema = v4.z.object({
  ...baseFields,
  mode: v4.z.literal("extend-video"),
  videoUrl: nonEmptyStringSchema,
  referenceImageUrls: v4.z.undefined().optional()
});
var referenceToVideoSchema = v4.z.object({
  ...baseFields,
  mode: v4.z.literal("reference-to-video"),
  referenceImageUrls: v4.z.array(nonEmptyStringSchema).min(1).max(7),
  videoUrl: v4.z.undefined().optional()
});
var autoDetectSchema = v4.z.object({
  ...baseFields,
  mode: v4.z.undefined().optional(),
...
var runtimeSchema = v4.z.object({
  mode: modeSchema.optional(),
  videoUrl: nonEmptyStringSchema.optional(),
  referenceImageUrls: v4.z.array(nonEmptyStringSchema).min(1).max(7).optional(),
  ...baseFields
}).passthrough();
var xaiVideoModelOptionsSchema = chunkZFOCQ6NW_cjs.lazySchema2(
  () => chunkZFOCQ6NW_cjs.zodSchema2(runtimeSchema)
);
var RESOLUTION_MAP = {
  "1280x720": "720p",
  "854x480": "480p",
...
var xaiCreateVideoResponseSchema = v4.z.object({
  request_id: v4.z.string().nullish()
});
var xaiVideoStatusResponseSchema = v4.z.object({
  status: v4.z.string().nullish(),
  video: v4.z.object({
    url: v4.z.string(),
    duration: v4.z.number().nullish(),
    respect_moderation: v4.z.boolean().nullish()
  }).nullish(),
  model: v4.z.string().nullish(),
  usage: v4.z.object({
    cost_in_usd_ticks: v4.z.number().nullish()
  }).nullish(),
  progress: v4.z.number().nullish(),
  error: v4.z.object({
    code: v4.z.string().nullish(),
    message: v4.z.string().nullish()
  }).nullish()
...
function createXai(options = {}) {
  var _a15;
  const baseURL = chunkZFOCQ6NW_cjs.withoutTrailingSlash2(
  ...
  const createChatLanguageModel = (modelId) => {
    return new XaiChatLanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: chunkZFOCQ6NW_cjs.generateId2,
      fetch: options.fetch
    });
  };
...
var _a6;
var InvalidResponseDataError3 = class extends AISDKError2 {
  constructor({
    data,
...
var _a14;
var UnsupportedFunctionalityError3 = class extends AISDKError2 {
  constructor({
    functionality,
...
var CommonReasoningDetailSchema = v4.z.object({
  id: v4.z.string().nullish(),
  format: v4.z.enum(ReasoningFormat).nullish(),
...
var openrouterFailedResponseHandler = createJsonErrorResponseHandler3({
  errorSchema: OpenRouterErrorResponseSchema,
  errorToMessage: (data) => data.error.message
});
var FileAnnotationSchema = v4.z.object({
...
function getFileUrl({
  ...
  if (part.data instanceof Uint8Array) {
    const base64 = convertUint8ArrayToBase643(part.data);
...
var OpenRouterChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { value: responseValue, responseHeaders } = await postJsonToApi3({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
    ...
    if (choice.message.tool_calls) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_j = toolCall.id) != null ? _j : generateId3(),
          toolName: toolCall.function.name,
          input: toolCall.function.arguments,
          providerMetadata: {
            openrouter: {
        ...
        new TransformStream({
          transform(chunk, controller) {
            ...
            const emitReasoningChunk = (chunkText, providerMetadata) => {
              if (!reasoningStarted) {
                reasoningId = openrouterResponseId || generateId3();
                controller.enqueue({
                  providerMetadata,
                  type: "reasoning-start",
                  id: reasoningId
            ...
            if (delta.content) {
              ...
              if (!textStarted) {
                textId = openrouterResponseId || generateId3();
                controller.enqueue({
                  type: "text-start",
                  id: textId
                });
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_g = toolCall2.function) == null ? void 0 : _g.name) != null && ((_h = toolCall2.function) == null ? void 0 : _h.arguments) != null && isParsableJson3(toolCall2.function.arguments)) {
                ...
                if (((_m = toolCall.function) == null ? void 0 : _m.name) != null && ((_n = toolCall.function) == null ? void 0 : _n.arguments) != null && isParsableJson3(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_o = toolCall.id) != null ? _o : generateId3(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments,
                    providerMetadata: {
                      openrouter: {
            ...
            if (finishReason === "tool-calls") {
              for (const toolCall of toolCalls) {
                if (toolCall && !toolCall.sent) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_a16 = toolCall.id) != null ? _a16 : generateId3(),
                    toolName: toolCall.function.name,
...
var openrouterEmbeddingUsageSchema = v4.z.object({
  prompt_tokens: v4.z.number(),
  total_tokens: v4.z.number(),
  cost: v4.z.number().optional()
});
var openrouterEmbeddingDataSchema = v4.z.object({
  object: v4.z.literal("embedding"),
  embedding: v4.z.array(v4.z.number()),
  index: v4.z.number().optional()
});
var OpenRouterEmbeddingResponseSchema = v4.z.object({
  id: v4.z.string().optional(),
  object: v4.z.literal("list"),
  data: v4.z.array(openrouterEmbeddingDataSchema),
  model: v4.z.string(),
...
function createOpenRouter(options = {}) {
  var _a15, _b, _c;
  const baseURL = (_b = withoutTrailingSlash3((_a15 = options.baseURL) != null ? _a15 : options.baseUrl)) != null ? _b : "https://openrouter.ai/api/v1";
...
var ModelsDevGateway = class extends chunkZFOCQ6NW_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async fetchProviders() {
    ...
    for (const [providerId, providerInfo] of Object.entries(data)) {
      if (chunkZFOCQ6NW_cjs.EXCLUDED_PROVIDERS.includes(providerId)) continue;
      ...
      const hasInstalledPackage = chunkZFOCQ6NW_cjs.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
      ...
      if (isOpenAICompatible || hasInstalledPackage || hasApiAndEnv) {
        ...
        const attachmentModels = activeModels.filter(([, modelInfo]) => modelInfo?.attachment === true).map(([modelId]) => modelId).sort();
        const url = PROVIDER_OVERRIDES[normalizedId]?.url || providerInfo.api;
        if (!hasInstalledPackage && !url) {
          continue;
        }
        const apiKeyEnvVar = PROVIDER_OVERRIDES[normalizedId]?.apiKeyEnvVar || selectApiKeyEnvVar({
  ...
  async resolveLanguageModel({
    ...
    const mastraHeaders = { "User-Agent": chunkZFOCQ6NW_cjs.MASTRA_USER_AGENT, ...headers };
    switch (providerId) {
      case "openai":
        return chunkZFOCQ6NW_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
      case "google":
        return chunkZFOCQ6NW_cjs.createGoogleGenerativeAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
      case "anthropic":
        return chunkZFOCQ6NW_cjs.createAnthropic({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "mistral":
      ...
      case "vercel":
        return chunk4SCYX53T_cjs.createGatewayProvider({ apiKey, baseURL, headers: mastraHeaders })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
      ...
      default: {
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkZFOCQ6NW_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).chat(modelId);
        }
        ...
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunkZFOCQ6NW_cjs.createOpenAICompatible({
          name: providerId,
          apiKey,
          baseURL,
...
//# sourceMappingURL=chunk-DK36PFIR.cjs.map
//# sourceMappingURL=chunk-DK36PFIR.cjs.map