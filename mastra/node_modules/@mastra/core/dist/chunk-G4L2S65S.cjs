...
var SkillsStorage = class extends chunk7Q5UQ5ES_cjs.VersionedStorageDomain {
  listKey = "skills";
...
// src/storage/domains/skills/skill-snapshot-field-equal.ts
function skillSnapshotFieldValuesEqual(a, b) {
  if (a === b) return true;
  ...
  const objectA = a;
  const objectB = b;
  const keys = Array.from(/* @__PURE__ */ new Set([...Object.keys(objectA), ...Object.keys(objectB)])).filter((key) => !(objectA[key] == null && objectB[key] == null)).sort();
...
exports.skillSnapshotFieldValuesEqual = skillSnapshotFieldValuesEqual;
//# sourceMappingURL=chunk-G4L2S65S.cjs.map
//# sourceMappingURL=chunk-G4L2S65S.cjs.map